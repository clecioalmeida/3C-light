                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" class="form-group" name="cod_dest">
                                    <?php                                                           
                                        while($dados_dest=mysqli_fetch_assoc($res_dest)) {?>
                                        <option value="<?php echo $dados_dest['cod_cliente']; ?>"><?php echo $nm_cliente;?></option>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" name="ds_modalidade">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" name="fl_tipo">
                                    <?php
                                    require_once('bd_class.php');
                                    $objDb = new db();
                                    $link = $objDb->conecta_mysql();
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" name="ds_frete">
