...
$query_init="select count(produto) as total
    ...
    where nr_pedido = '$nr_pedido' and produto = '$cod_produto' and ds_galpao = '$galpao' and ds_prateleira = '$rua' and ds_coluna = '$col' and ds_altura = '$alt'";
...
if($count < $qtd){
    ...
    $upd_conf="update tb_coleta_pedido set nr_qtde_conf = '$count_upd' where nr_pedido = '$nr_pedido' and produto = '$barcode'";
