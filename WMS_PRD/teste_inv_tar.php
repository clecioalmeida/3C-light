...
$sql_etq ="select t1.id, t1.id_produto, t1.id_galpao, t1.id_rua, t1.id_coluna, t1.id_altura, t1.nr_volume,t3.cont_2, t4.cod_prod_cliente, t1.fl_empresa
from tb_inv_tarefa t1
left join tb_posicao_pallet t2 on t1.id_rua = t2.ds_prateleira and t1.id_coluna = t2.ds_coluna and t1.id_altura = t2.ds_altura
left join tb_inv_conf t3 on t1.id = t3.id_tar
left join tb_produto t4 on t1.id_produto = t4.cod_produto
where t2.id_tar is null and t1.fl_empresa = 3 and t1.id_produto > 0";
