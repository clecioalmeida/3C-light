...
$SQL1 = "select count(nr_pedido) as pedidos from tb_pedido_coleta where fl_status = 'A'";
...
where fl_status = 'P' or fl_status = 'M' or fl_status = 'C' or fl_status = 'F'";
														...
														<form method="POST" class="form-inline" id="formAlocCod" action=""><br><br>
												            <fieldset>
																<div class="col-sm-8" style="text-align: left;">
																	...
																	<div class="form-group">
																		<div class="checkbox">
																			<label class="checkbox-inline" style="vertical-align: center">
																				<input type="checkbox" class="checkbox" value="A" name="pesqStatus" id="PesqStatusAberto" checked="true" style="width: 18px;height: 18px">
																				<span>Abertos</span>
																			</label>
																			<label class="checkbox-inline" style="vertical-align: center">
																				<input type="checkbox" class="checkbox" value="C" name="pesqStatus" id="PesqStatusColeta" style="width: 18px;height: 18px">
																				<span>Coletando</span>
																			</label>
																			<label class="checkbox-inline" style="vertical-align: center">
																				<input type="checkbox" class="checkbox" value="E" name="pesqStatus" id="PesqStatusExpede" style="width: 18px;height: 18px">
																				<span>Expedição</span>
																			</label>
