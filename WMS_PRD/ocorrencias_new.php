...
<div id="main" role="main">
    <div id="ribbon">
        <div class="col-sm-4">
            <ol class="breadcrumb">
            <li>Home</li><li>Qualidade</li><li>Ocorrências</li>
            </ol>
        </div>
    </div>
    <div id="content">
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                ...
                                <ul id="myTab1" class="nav nav-tabs bordered">
                                    <li class="active">
                                        <a href="#s6" id="btnOcorPend" data-toggle="tab">OCORRÊNCIAS PENDENTES <span class="badge bg-color-blue txt-color-white"></span></a>
                                    </li>
                                    <li>
                                        <a href="#s1" id="btnOCorFin" data-toggle="tab">OCORRÊNCIAS FINALIZADAS </a>
                                    </li>
                                    <!--li>
                                        ...
                                        <article>
                                            <div>
                                                <form class="form-horizontal" method="post" action="" id="">
                                                    <button type="button" class="btn btn-success btn-xs" id="btnOCorNew" style="margin-right: 3px">NOVA OCORRÊNCIA</button>
                                                    <span> | </span>
