<?php
	...
	if((isset($_POST['username'])) && (isset($_POST['password']))){
		...
		$SQL = "select cod_cliente, nm_cliente, avatar, cod_cli, fl_nivel from tb_cliente where nm_usuario = '$usuario' and ds_senha = '$senha' and (fl_tipo = 'F' or fl_tipo = 'U') and fl_status = '1' "; 
		...
		if(isset($dados)){
			...
			$_SESSION['usuario'] = $dados['nm_cliente'];
			$_SESSION['fl_nivel'] = $dados['fl_nivel'];
			$_SESSION['cod_cli'] = $dados['cod_cli'];
