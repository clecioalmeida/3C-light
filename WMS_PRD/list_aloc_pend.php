...
$sql = "select t1.cod_nf_entrada_item, t2.cod_produto, t2.cod_prod_cliente, t2.nm_produto, t3.nr_fisc_ent, t3.qtd_vol_ent, t3.tp_vol_ent, t4.ds_galpao, t4.nr_fisc_ent, t4.ds_prateleira, t4.ds_coluna, t4.ds_altura, t4.nr_qtde
...
where t4.NR_OR = 0 and t4.nr_qtde > 0
...
<section class="panel col-lg-12">
    ...
    <legend>Pedidos em conferência</legend>
                                        <table class="table table-hover" style="font-size: x-small;width: 100%">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                 <tr id="trStatus" class="status" data-status="<?php echo $linha['fl_status'];?>">
                                                    <td id="cod_produto" style="text-align: center;"><?php echo $dados['nr_fisc_ent'];?></td>
                                                    ...
                                                    <td style="text-align: right;"><?php echo $dados['ds_galpao'];?></td>
