...
$id_usuario = mysqli_real_escape_string($link, $_POST["upd_usuario"]);
...
<div class="modal fade" id="alterar_usuario" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body modal-lg" style="overflow-y: auto">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  value="<?php echo $nm_cliente; ?>" id="u_nome">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="cpf">CPF</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  value="<?php echo $nr_cnpj_cpf; ?>" id="cpf">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="rg">RG</label>
                        <div class="col-sm-4">
                           <input type="text" class="form-control"  value="<?php echo $ds_ie_rg; ?>" id="rg">
                           <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  value="<?php echo $nm_usuario; ?>" id="login">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="departamento">Departamento</label>
                        <div class="col-sm-4">
                           <input type="text" class="form-control"  value="<?php echo $nm_dpto; ?>" id="departamento">
                           <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  value="<?php echo $nm_cargo; ?>" id="cargo">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="email">E-mail</label>
                        <div class="col-sm-4">
                           <input type="text" class="form-control"  value="<?php echo $ds_email; ?>" id="email">
                           <div class="form-control-focus"> </div>
                       </div>
                     </div>
                   <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  value="<?php echo $ds_endereco; ?>" id="endereco">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="bairro">Bairro</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  value="<?php echo $ds_bairro; ?>" id="bairro">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="cep">CEP</label>
                        <div class="col-sm-4">
                           <input type="text" class="form-control"  value="<?php echo $ds_cep; ?>" id="cep">
                           <div class="form-control-focus"> </div>
                       </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="cidade">Cidade</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  value="<?php echo $ds_cidade; ?>" id="cidade">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="uf">UF</label>
                        <div class="col-sm-4">
                           <input type="text" class="form-control"  value="<?php echo $ds_uf; ?>" id="uf">
                           <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  value="<?php echo $nr_telefone; ?>" id="telefone">
                            <div class="form-control-focus"> </div>
                        </div>
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" value="<?php echo $fl_status; ?>" id="fl-status">
                <div class="form-control-focus"> </div>
            </div>
            <label class="col-sm-2 control-label" for="status">Nível</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" value="<?php echo $fl_nivel; ?>" id="fl_nivel">
            </div>
        </div>
       </div>
