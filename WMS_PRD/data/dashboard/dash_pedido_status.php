        ...
        <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="false">
            ...
            <div>
                ...
                <div class="widget-body no-padding">
                    <div id="pedido_sts" class="chart no-padding"></div>
                </div>
            </div>
        </div>
        <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="false">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var my_chart = new Morris.Bar({
            ...
            xkey: 'mes',
            ykeys: ['ped_pend'],
            labels: ['% não finalizado']
        });

        $.ajax 
        ({
            url:"data/dashboard/chart_ped_sts.php",
            method: "GET",
            dataType: "json",
            success: function(pedido_sts){
               my_chart.setData(pedido_sts);console.log(pedido_sts);
           }
       });
    });
</script>
