<?php 
 ...
 ?>
 <div class="modal fade" id="recListIndNfSku" aria-hidden="true">
                ...
                <table id="RepIndCronExcel" class="table table-bordered" width="100%" style="font-size: 10px">
                  <thead>
                    <tr>
                      ...
                      <th>TOTAL SKUs RECEBIDOS</th>
                      <th>MÉDIA SKUs / FORNECEDOR</th>
                      <th>AÇÕES</th>
                    </tr>
                  </thead>
                  <tbody id="listTbNfSku">
                  </tbody>
                </table>
              </div>
            </section>
