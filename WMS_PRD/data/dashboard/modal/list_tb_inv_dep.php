...
where id = '$id_ind'";
 ...
 while ($dados = mysqli_fetch_assoc($res_prod)) {?>
  <tr class="odd gradeX">
    ...
    <td id="nr_sku_falta" contenteditable="true" style="text-align: right;width:50px"><?php echo $dados['nr_sku_falta']; ?></td>
    <td id="nr_ac_sku" contenteditable="true" style="text-align: right;width:50px"><?php echo $dados['nr_ac_sku']; ?></td>
    ...
    <td style="text-align: right;width:100px"><?php echo $dados['vlr_fim']; ?></td>
    <td style="text-align: right;width:50px"><?php echo $dados['vlr_div']; ?></td>
   <td style="text-align: left;width:300px">
    <button type="submit" class="btn btn-primary btn-xs btnSaveUpdInvDep" id="btnSaveUpdInvDep" value="<?php echo $dados['id'];?>">SALVAR</button>
