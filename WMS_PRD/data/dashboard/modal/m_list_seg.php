              ...
              <div class="table-responsive-sm">
                <table id="RepIndCronExcel" class="table" width="100%">
                  <thead>
                    <tr>
                      <th>DATA</th>
                      <!--th>QTDE IPAL PREVISTO</th>
                      <th>QTDE IPAL EXECUTADAS</th-->
                      <th>IRREGULARIDADES DE SSO</th>
                      <th>QTDE ACIDENTES FATAIS</th>
                      <th>AÇÕES</th>
                    </tr>
                  </thead>
                  <tbody id="listTbSeg">
...
<script>
  $(document).ready(function () {
    ...
    $('#listTbSeg').load('data/dashboard/modal/list_tb_seg.php?search=',{id_ind:id_ind});
  });
</script>