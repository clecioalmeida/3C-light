 ...
 while ($ocupacao = mysqli_fetch_assoc($res_ocp)) {?>
  <tr class="odd gradeX">
    ...
    <td style="text-align: left;width:150px">
      <button type="submit" class="btn btn-primary btn-xs btnUpOcupExt" id="btnUpOcupExt" value="<?php echo $ocupacao['id'];?>">ALTERAR</button>
      <button type="submit" class="btn btn-danger btn-xs btnDelOcupExt" id="btnDelOcupExt" value="<?php echo $ocupacao['id'];?>" disabled>EXCLUIR</button>
  </td>
</tr>
<?php }
