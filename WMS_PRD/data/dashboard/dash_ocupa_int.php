...
$query_transp = "select id, ds_data, nr_total_sku, nr_pos_ocp, nr_ocupa_sku from tb_fc_est where fl_tipo = 'I' and fl_empresa = '$cod_cli' order by ds_data desc";
$res_transp = mysqli_query($link, $query_transp);

$sql_ocupa = "select date_format(dt_fechamento,'%d-%m-%Y') as dt_fechamento, nr_ocp, nr_ocp_sku, nr_ocp_perc from tb_fc_saldo_dia where fl_tipo = 'I' and fl_empresa = '$cod_cli' and dt_fechamento BETWEEN CURRENT_DATE() -30 AND CURRENT_DATE() order by date(dt_fechamento) desc";
$res_ocp = mysqli_query($link, $sql_ocupa);

$link->close();
?>
<?php include 'chart_ocupa_int.php';?>
<style type="text/css">
  .teste1 {
    position:relative;
    width:100px;
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  <button type="buttom" id="btnCadIndSeg" class="btn btn-info btn-xs" disabled style="float:left;width: 150px;background-color: #0061B3">NOVO</button>
</div>
<br><br>
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  <img class="pull-left" src="img/logo3c.png" alt="3C" style="width: 7%; height: 5.3%; margin-top: 0px">
  <span class="teste2"><h1><strong>Ocupação interna</strong></h1></span>
    ...
    <div class="widget-body">
        ...
        <table id="RepIndDemExcel" class="table" width="100%">
          ...
          <tbody>
            ...
            while ($dados = mysqli_fetch_assoc($res_transp)) {?>
              <tr class="odd gradeX">
                <td class="ind_ocupa_int" data-ind="<?php echo $dados['id'];?>" style="text-align: left;width:100px"><?php echo $dados['ds_data']; ?></td>
                <td class="ind_ocupa_int" data-ind="<?php echo $dados['id'];?>" style="text-align: right;width:100px"><?php echo $dados['nr_total_sku']; ?></td>
                <td class="ind_ocupa_int" data-ind="<?php echo $dados['id'];?>" style="text-align: right;width:100px"><?php echo $dados['nr_pos_ocp']; ?></td>
                <td class="ind_ocupa_int" data-ind="<?php echo $dados['id'];?>" style="text-align: right;width:100px"><?php echo $dados['nr_ocupa_sku']."%"; ?></td>
              </tr>
            </tbody>
          <?php }?>
        </table>
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" id="printGraph">
        <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="false">
          <header>
            ...
            <h2>PERCENTUAL DE OCUPAÇÃO - INTERNO</h2>
          </header>
          <div>
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" id="printGraph">
        <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="false">
          <header>
            <span class="widget-icon"></span>
            <h2>TOTAL DE SKU'S ARMAZENADOS</h2>
          </header>
          <div>
            <div class="widget-body no-padding">
