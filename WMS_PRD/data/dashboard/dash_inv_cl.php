...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  <button type="buttom" id="btnCadInvCl" class="btn btn-info btn-xs" style="float:left;width: 150px;background-color: #0061B3">NOVO</button>
</div>
<br><br>
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  <img class="pull-left" src="img/logo3c.png" alt="3C" style="width: 7%; height: 5.3%; margin-top: 0px">
  <span class="teste2"><h1><strong>Acuracidade do estoque CL</strong></h1></span>
        ...
        <tbody>
          ...
          while ($dados = mysqli_fetch_array($res_vg)) {
            ...
            foreach(array_combine($id, $nr_sku_qtde) as $d => $l){
              ...
              $a .= "<td class='indInvCl' data-ind=".$d." style='text-align:right'>".$l."</td>";
            ...
            foreach(array_combine($id, $nr_sku_sobra) as $d => $m){
              ...
              $b .= "<td class='indInvCl' data-ind=".$d." style='text-align:right'>".$m."</td>";
            ...
            foreach(array_combine($id, $nr_sku_falta) as $d => $n){
              ...
              $c .= "<td class='indInvCl' data-ind=".$d." style='text-align:right'>".$n."</td>";
            ...
            foreach(array_combine($id, $nr_ac_sku) as $d => $o){
              ...
              $u .= "<td class='indInvCl' data-ind=".$d." style='text-align:right'>".$o."</td>";
            ...
            foreach(array_combine($id, $vlr_ini) as $d => $p){
              ...
              $e .= "<td class='indInvCl' data-ind=".$d." style='text-align:right'>".$p."</td>";
            ...
            foreach(array_combine($id, $vlr_sobra) as $d => $q){
              ...
              $f .= "<td class='indInvCl' data-ind=".$d." style='text-align:right'>".$q."</td>";
            ...
            foreach(array_combine($id, $vlr_falta) as $d => $t){
              ...
              $i .= "<td class='indInvCl' data-ind=".$d." style='text-align:right'>".$t."</td>";
            ...
            foreach(array_combine($id, $vlr_fim) as $d => $r){
              ...
              $g .= "<td class='indInvCl' data-ind=".$d." style='text-align:right'>".$r."</td>";
            ...
            foreach(array_combine($id, $vlr_div) as $d => $s){
              ...
              $h .= "<td class='indInvCl' data-ind=".$d." style='text-align:right'>".$s."</td>";
  ...
  <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="false">
    <div>
      <div class="widget-body no-padding">
        <div id="inv_cl" class="chart no-padding"></div>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript">
  ...
  Morris.Bar(config).on('click', function(i, row){
    ...
    $.ajax
    ({
      url:"data/dashboard/modal/m_list_inv_cl.php",
      method:"POST",
      data:{id_ind:id_ind},
