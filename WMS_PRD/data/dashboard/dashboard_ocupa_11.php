...
WHERE NOT EXISTS (SELECT distinct(id_endereco) FROM tb_posicao_pallet p WHERE e.id = p.id_endereco)";
    ...
    $sql_altura = "select distinct(altura) from tb_endereco where galpao = 11 and rua = 'a01'";
    $res_altura = mysqli_query($link,$sql_altura);
    $sql_alturaA03 = "select distinct(altura) from tb_endereco where galpao = 11 and rua = 'a03'";
    $res_alturaA03 = mysqli_query($link,$sql_alturaA03);
    $sql_coluna = "select distinct(coluna) from tb_endereco where galpao = 11 and rua = 'a01'";
    $res_coluna = mysqli_query($link,$sql_coluna);
    $sql_colunaA03 = "select distinct(coluna) from tb_endereco where galpao = 11 and rua = 'a03'";
    $res_colunaA03 = mysqli_query($link,$sql_colunaA03);
    $sql_colunaA05 = "select distinct(coluna) from tb_endereco where galpao = 11 and rua = 'a05'";
    $res_colunaA05 = mysqli_query($link,$sql_colunaA05);
    $sql_colunaA07 = "select distinct(coluna) from tb_endereco where galpao = 11 and rua = 'a07'";
    $res_colunaA07 = mysqli_query($link,$sql_colunaA07);
    $sql_colunaA09 = "select distinct(coluna) from tb_endereco where galpao = 11 and rua = 'a09'";
    $res_colunaA09 = mysqli_query($link,$sql_colunaA09);
    $sql_colunaA11 = "select distinct(coluna) from tb_endereco where galpao = 11 and rua = 'a11'";
    $res_colunaA11 = mysqli_query($link,$sql_colunaA11);
    $sql_colunaA13 = "select distinct(coluna) from tb_endereco where galpao = 11 and rua = 'a13'";
    $res_colunaA13 = mysqli_query($link,$sql_colunaA13);
    $sql_colunaA151 = "select distinct(coluna) from tb_endereco where galpao = 11 and rua = 'a15' and coluna <='14E'";
    $res_colunaA151 = mysqli_query($link,$sql_colunaA151);
    $sql_colunaA152 = "select distinct(coluna) from tb_endereco where galpao = 11 and rua = 'a15' and coluna >'14E'";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a01' and t1.altura = 'A' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a01' and t1.altura = 'B' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a01' and t1.altura = 'C' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a01' and t1.altura = 'D' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a03' and t1.altura = 'A' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a03' and t1.altura = 'B' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a03' and t1.altura = 'C' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a03' and t1.altura = 'D' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a05' and t1.altura = 'A' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a05' and t1.altura = 'B' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a05' and t1.altura = 'C' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a05' and t1.altura = 'D' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a07' and t1.altura = 'A' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a07' and t1.altura = 'B' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a07' and t1.altura = 'C' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a07' and t1.altura = 'D' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a09' and t1.altura = 'A' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a09' and t1.altura = 'B' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a09' and t1.altura = 'C' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a09' and t1.altura = 'D' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a11' and t1.altura = 'B' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a11' and t1.altura = 'C' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a11' and t1.altura = 'D' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a13' and t1.altura = 'A' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a13' and t1.altura = 'B' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a13' and t1.altura = 'C' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a13' and t1.altura = 'D' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a15' and t1.altura = 'A' and t1.coluna <='14E' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a15' and t1.altura = 'B' and t1.coluna <='14E' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a15' and t1.altura = 'C' and t1.coluna <='14E' group by t1.id";
...
and t1.altura = t2.ds_altura where t1.galpao = 11 and t1.rua = 'a15' and t1.altura = 'D' and t1.coluna <='14E' group by t1.id";
