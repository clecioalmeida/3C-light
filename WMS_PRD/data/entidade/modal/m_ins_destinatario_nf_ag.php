<div class="modal fade" id="novo_destinatario_nf" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
     <form class="form-horizontal" method="post" action="" id="formCadDestinatarioNf">
        <div class="modal-content">
          <div class="modal-header" style="background-color: #22262E;">
            <h5 class="modal-title" id="novo" style="color: white">Incluir Destinatários</h5>
        ...
        <div class="modal-body modal-lg" style="overflow-y: auto">
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control" name="nr_cnpj_cpf" id="nr_cnpj_cpf" placeholder="CNPJ">
                    ...
                    <div class="col-md-2">
                        <div class="input-group input-group-md">
                            <input type="text" class="form-control" name="ds_uf_con" id="ds_uf_con" placeholder="UF">
                            <span class="input-group-btn">
                                <button class="btn btn-info" type="button" id="btnConsDestNfCnpj"><span class="fa fa-search"></span></button>
                            </span>
                        </div>
                        <div class="form-control-focus"> </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="r_social" id="r_social" placeholder="Razão social">
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label" for="ds_obs_cte">Observação</label>
                    <div class="col-md-10">
        ...
        <div class="modal-footer" style="background-color: #22262E;">
            ...
            <button type="submit" class="btn btn-primary" id="btnCadDestinatarioNf">Incluir</button>
        </div>
    </div>
</form>
</div>
...
<script>
    $(document).ready(function () {
        $('#novo_destinatario_nf').modal('show');
