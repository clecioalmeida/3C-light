...
$sql = "INSERT INTO tb_acesso (ds_nome, ds_usuario, nr_cnpj_transp, nr_cnpj_cliente, ds_senha, id_oper, fl_status, usr_create, dt_create) VALUES ('$ds_nome', '$nr_cnpj', '$cod_cli', '$id_cli', '$ds_senha', '3,4', 'A','$id', '$date')";
