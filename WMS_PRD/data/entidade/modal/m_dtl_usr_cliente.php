...
$id_usr_cliente = mysqli_real_escape_string($link, $_POST["dtl_usr_cliente"]);

$SQL = "select * from tb_cliente where cod_cliente = '$id_usr_cliente'"; 
...
$link->close();
?>
<div class="modal fade" id="detalhe_usr_cliente" aria-hidden="true">
...
<script>
    $(document).ready(function () {
        $('#detalhe_usr_cliente').modal('show');
    });
</script>