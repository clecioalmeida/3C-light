...
if (mysqli_affected_rows($link1) > 0) {
	...
	$sql = "insert into tb_cliente (nm_cliente, nr_cnpj_cpf, ds_ie_rg, ds_endereco, ds_numero, ds_bairro, ds_cidade, ds_uf, ds_cep, nr_telefone, ds_email, nm_fantasia, nm_contato, ds_complemento, fl_tipo, fl_status) values ('$nm_cliente', '$nr_cnpj_cpf',  '$ds_ie_rg', '$ds_endereco', '$ds_numero', '$ds_bairro', '$ds_cidade', '$ds_uf', '$ds_cep', '$nr_telefone', '$ds_email', '$nm_fantasia', '$nm_contato', '$ds_complemento', 'C', 'A')";
	$resultado_id = mysqli_query($link, $sql);
	$novoCli = mysqli_insert_id($link);
