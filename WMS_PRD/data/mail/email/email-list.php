<table class="table table-striped table-hover">
		...
		<!--tr id="msg1" class="unread">
			<td class="inbox-table-icon">
				...
				<td class="inbox-data-message">
					<div>
						<span><span class="label bg-color-orange">COLETA</span> Karjua Marou</span> New server for datacenter needed
					</div>
				</td>
        ...
        $(document).ready(function(){
            ...
            function(j){
                ...
                for (var i = 0; i < j.length; i++) {
                   $('#retMail').append('<tr id="'+j[i].msg_id+'" class="unread">\
                    <td class="inbox-table-icon">\
                    <div class="checkbox">\
                    <label>\
                    <input type="checkbox" class="checkbox style-2">\
                    ...
                    <td class="inbox-data-message">\
                    <div>\
                    <span><span class="label bg-color-orange">COLETA</span> </span> '+ j[i].assunto +'\
                    </div>\
                    </td>\
                    <td class="inbox-data-attachment hidden-xs">\
                    <div>\
	...
	function getMail($this) {
		...
		loadURL("mail/email-opened.html", $('#inbox-content > .table-wrap'));
	}
