											...
											<form id="form_conf_PP" method="" action="">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" id="cod_produto" name="cod_produto" class="form-control" required="true" autofocus="true" style="text-align: right;">
														<label>SERIAL:</label>
														<input type="text" id="nr_serial" name="nr_serial" class="form-control" style="text-align: right;">
														<label>QUANTIDADE:</label>
														<input type="text" id="nr_qtde" name="nr_qtde" class="form-control" style="text-align: right;">
														<div class="ui-grid-b">
															<div class="ui-block-a"><input type="text" id="ds_kva" name="ds_kva"  value="" placeholder="KVA"></div>
															<div class="ui-block-b"><input type="text" id="ds_lp" name="ds_lp"  value="" placeholder="LP"></div>
															<div class="ui-block-c"><input type="text" id="ds_fabr" name="ds_fabr"  value="" placeholder="FABRICANTE"></div>
														</div>
														<div class="ui-grid-b">
															<div class="ui-block-a"><input type="text" id="ds_ano" name="ds_ano"  value="" placeholder="Ano"></div>
