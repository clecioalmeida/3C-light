...
$id_rua_ini = $_POST['id_rua_ini'];
$id_rua_fim = $_POST['id_rua_fim'];

$sql_local = "select t1.id, t1.nome, t2.cod_estoque, t2.ds_galpao, t2.produto, t2.ds_galpao, t2.ds_prateleira, t2.ds_coluna, t2.ds_altura, format(t2.nr_qtde,0) as nr_qtde, round(t2.nr_volume,0) as nr_volume, case when t2.dt_validade = '0' then '' else date_format(t2.dt_validade,'%d/%m/%Y') end as dt_validade, t6.nr_docto as cod_ca, date_format(t6.dt_docto,'%d/%m/%Y') as dt_ca, t7.nr_docto as cod_laudo, date_format(t7.dt_docto,'%d/%m/%Y') as dt_laudo, t3.cod_prod_cliente, t3.nm_produto, t2.nr_or, date_format(t4.dt_recebimento_real,'%d/%m/%Y') as dt_recebimento, t2.id_tar, date_format(t5.dt_create,'%d/%m/%Y') as dt_tarefa, t8.id as id_etq, t8.cod_estoque as cod_est_etq
from tb_armazem t1
...
where t2.nr_qtde > 0 and t2.fl_status = 'A' and t2.produto > 0 and t2.ds_galpao = '$id_galpao' and t2.ds_prateleira >= '$id_rua_ini' and t2.ds_prateleira <= '$id_rua_fim'
...
if ($tr_local) { ?>
    ...
    <div class="col-sm-12 text-align-right">
        <div class="btn-group">
            ...
            <button onclick="printContent('reportSalEstoque')" type="submit" class="btn btn-primary btn-xs" id="RepEstoqGenPdf" style="float:right;width: 100px">Imprimir</button>
        </div>
    </div>
    <div id="reportSalEstoque">
        <div class="padding-10">
            <br>
            <br>
            <table class="display responsive nowrap" id="example9" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td style="text-align: center; width: 100px">
                                ...
                                <?php if ($dados_local['id_etq']) { ?>
                                    ...
                                    <svg id="barcode" class="barcode" jsbarcode-format="auto" jsbarcode-height="30" jsbarcode-displayValue="true" jsbarcode-value="<?php echo $dados_local['produto'] . "-" . $dados_local['id_etq']; ?>" jsbarcode-textmargin="0" jsbarcode-fontoptions="bold">
                                    </svg>
