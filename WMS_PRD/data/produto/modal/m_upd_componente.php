...
$id_comp = mysqli_real_escape_string($link, $_POST["upd_comp"]);
...
$SQL = "select t1.cod_prod_cliente, t1.cod_produto, t1.nm_produto, t1.tp_separacao, t1.cod_cli, t1.cod_grupo, t1.cod_sub_grupo, t1.codncm, t1.fl_lote, t1.ean, t1.peso, t1.peso_bruto, t1.curva, t1.nr_estoque_min, t1.volume, t1.unid, t1.unid_controle, t1.altura, t1.compr, t1.largura, t1.cod_identificacao, t1.multiplo, t1.detalhe_produto, t1.id_armazem, t1.aloc_aut, t2.cod_cliente, t2.nm_cliente, t3.cod_grupo, t3.nm_grupo, t4.cod_sub_grupo, t4.nm_sub_grupo, t5.id, t5.nome 
    ...
    where t1.cod_produto = '$id_comp' and t1.fl_tipo_comp = 1"; 
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header" style="background-color: #2F4F4F;">
                    <h5 class="modal-title" id="alterar_produto" style="color: white">Alterar produto <?php echo $cod_produto; ?></h5>
                ...
                <fieldset>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nm_cliente" value="<?php echo $nm_cliente; ?>" id="nm_cliente" placeholder="Cliente" readonly="readonly">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $cod_prod_cliente; ?>" name="cod_prod_cliente" id="p_cliente" placeholder="Cód. Cliente" readonly="readonly">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $codncm; ?>" name="codncm" id="p_ncm" placeholder="NCM">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" value="<?php echo $cod_produto; ?>" name="cod_produto" id="p_estoque" placeholder="Cód. Estoque">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="p_ean">EAN</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $ean; ?>" name="ean" id="p_ean" placeholder="EAN">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" value="<?php echo $peso; ?>" name="peso" id="p_peso_l" placeholder="Peso líquido">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 form-md">
                            <input type="text" class="form-control" value="<?php echo $peso_bruto; ?>" name="peso_bruto" id="p_peso_b" placeholder="Peso bruto">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 form-md">
                            <input type="text" class="form-control" value="<?php echo $detalhe_produto; ?>" name="detalhe_produto" id="p_detalhe" placeholder="Detalhes">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="p_estoque_m">Estoque mínimo</label>
                        <div class="col-sm-4 form-md">
                            <input type="text" class="form-control" value="<?php echo $nr_estoque_min; ?>" name="nr_estoque_min" id="p_estoque_m" placeholder="Estoque mínimo">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $unid; ?>" name="unid" id="p_calculo" placeholder="Unid. de Cálculo">
                            <div class="form-control-focus"> </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $unid_controle; ?>" name="unid_controle" id="p_unid_estoque" placeholder="Unid. de Estoque">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="p_altura">Altura</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $altura; ?>" name="altura" id="p_altura" placeholder="Altura">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                       <label class="col-sm-2 control-label" for="cod_grupo">Grupo</label>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $nm_sub_grupo; ?>" name="nm_sub_grupo" id="form_control_sgrupo" placeholder="Sub-grupo" readonly="readonly">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $compr; ?>" name="compr" id="form_control_comprimento" placeholder="Comprimento">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="form_control_largura">Largura</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $largura; ?>" name="largura" id="form_control_largura" placeholder="Largura">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $multiplo; ?>" name="multiplo" id="form_control_multiplo" placeholder="Múltiplo">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
