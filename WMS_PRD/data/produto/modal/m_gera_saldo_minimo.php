...
left join tb_reposicao_item t7 on t1.produto = t7.cod_produto and t7.id_reposicao is null
left join tb_fornecedor t6 on t7.id_fornecedor = t6.cod_fornecedor
            ...
            <tbody>
                ...
                while ($dados = mysqli_fetch_assoc($res_req)) {?>
                    <tr class="odd gradeX">
                        ...
                        <td> <input class="form-control qtd_rep<?php echo $dados['produto']; ?>" type='text' id="qtd_rep" name="qtd_rep" value="<?php echo $dados['nr_qtde']; ?>" style="width: 100%;text-align: right;"/> </td>
                        <td> <input class="form-control dt_rep<?php echo $dados['produto']; ?>" type='date' id="dt_rep" name="dt_rep" value="<?php echo $dados['dt_previsto']; ?>" style="width: 100%;text-align: right;"/> </td>
                        <td style="text-align: right;">
                            <div class="input-group input-group-md retCadFor" id="retCadFor" style="width: 100%">
                                <input class="form-control cod_fornecedor<?php echo $dados['produto']; ?>" type='text' id="cod_fornecedor" name="cod_fornecedor" data-item="<?php echo $dados['id_item']; ?>" value="<?php echo $dados['nm_fornecedor']; ?>" style="width: 100%;text-align: left;"/>
