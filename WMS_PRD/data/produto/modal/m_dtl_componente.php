...
$sel_comp="select t1.cod_prod_cliente, t1.cod_produto, t1.nm_produto, t1.tp_separacao, t1.cod_cli, t1.cod_grupo, t1.cod_sub_grupo, t1.codncm, t1.fl_lote, t1.ean, t1.peso, t1.peso_bruto, t1.curva, t1.nr_estoque_min, t1.volume, t1.unid, t1.unid_controle, t1.altura, t1.compr, t1.largura, t1.cod_identificacao, t1.multiplo, t1.detalhe_produto, t1.id_armazem, t1.aloc_aut, t2.cod_cliente, t2.nm_cliente, t3.cod_grupo, t3.nm_grupo, t4.cod_sub_grupo, t4.nm_sub_grupo, t5.id, t5.nome 
    ...
    left join tb_armazem t5 on t1.id_armazem = t5.id where t1.fl_tipo_comp = 1 and t1.cod_produto = '$id_comp'";
$res_comp = mysqli_query($link, $sel_comp);
while ($dados = mysqli_fetch_assoc($res_comp)) {
...
$sql_cliente = "select * from tb_cliente where fl_status = 1 and fl_tipo = 'C'" or die(mysqli_error($sql));
...
$link->close();
?>
<div class="modal fade" id="detalhe_componente" aria-hidden="true">
             <form method="post" action="" id="formDtlProduto">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header" style="background-color: #2F4F4F;">
                    <h5 class="modal-title" id="alterar_produto" style="color: white">Consulta comoponente <?php echo $cod_produto; ?></h5>
                ...
                <div class="modal-body" style="overflow-y: auto">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $cod_prod_cliente; ?>" name="cod_prod_cliente" id="p_cliente" placeholder="Cód. Cliente" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $codncm; ?>" name="codncm" id="p_ncm" placeholder="NCM" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" value="<?php echo $cod_produto; ?>" name="cod_produto" id="p_estoque" placeholder="Cód. Estoque" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="p_ean">EAN</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $ean; ?>" name="ean" id="p_ean" placeholder="EAN" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" value="<?php echo $peso; ?>" name="peso" id="p_peso_l" placeholder="Peso líquido" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 form-md">
                            <input type="text" class="form-control" value="<?php echo $peso_bruto; ?>" name="peso_bruto" id="p_peso_b" placeholder="Peso bruto" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 form-md">
                            <input type="text" class="form-control" value="<?php echo $nr_estoque_min; ?>" name="nr_estoque_min" id="p_estoque_m" placeholder="Estoque mínimo" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $altura; ?>" name="altura" id="p_altura" placeholder="Altura" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $compr; ?>" name="compr" id="form_control_comprimento" placeholder="Comprimento" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                        <label class="col-sm-2 control-label" for="form_control_largura">Largura</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $largura; ?>" name="largura" id="form_control_largura" placeholder="Largura" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" value="<?php echo $multiplo; ?>" name="multiplo" id="form_control_multiplo" placeholder="Múltiplo" readonly="true">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group">
