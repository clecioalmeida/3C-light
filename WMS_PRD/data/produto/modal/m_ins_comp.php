...
$link->close();
?>
<div class="modal fade" id="novo_componente" aria-hidden="true">
 <form method="post" action="" id="formNovoComp">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #2F4F4F;">
        <h5 class="modal-title" id="novo_produto" style="color: white">Incluir componentes</h5>
      ...
      <div class="modal-body" style="overflow-y: auto">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <label><input type="radio" name="tp_separacao" value="fifo" id="p_separacao">Fifo</label>
                    <label><input type="radio" name="tp_separacao" value="fefo" id="p_separacao">Fefo</label>
                    <label><input type="radio" name="tp_separacao" value="comum" id="p_separacao">Comum</label>
                    <div class="form-control-focus"> </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <label><input type="radio" value="S" name="fl_lote" id="p_lote">Sim</label>
                    <label><input type="radio" value="N" name="fl_lote" id="p_lote">Não</label>
                    <div class="form-control-focus"> </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 form-md">
                    <label><input type="radio" value="A" name="curva" id="p_curva">A</label>
                    <label><input type="radio" value="B" name="curva" id="p_curva">B</label>
                    <label><input type="radio" value="C" name="curva" id="p_curva">C</label>
                <div class="form-control-focus"> </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <label><input type="radio" value="S" name="aloc_aut" id="aloc_aut1">Sim</label>
                    <label><input type="radio" value="N" name="aloc_aut" id="aloc_aut2">Não</label>
                    <div class="form-control-focus"> </div>
                </div>
            </div>
        </fieldset>
      ...
      <div class="modal-footer" style="background-color: #2F4F4F;">
          <button type="submit" class="btn btn-primary" id="btnFormNovoComp">Salvar</button>
