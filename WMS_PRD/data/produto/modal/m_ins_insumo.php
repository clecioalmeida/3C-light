  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="overflow-y: auto">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="ds_produto">Tipo</label>
                <div class="col-sm-4">
                    <select class="form-control" name="ds_produto" id="ds_produto">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="aloc_aut">Alocação automática</label>
                <div class="col-md-4">
    ...
    <div class="modal-footer" style="background-color: #2F4F4F;">
        <button type="submit" class="btn btn-primary" id="btnFormNovoInsumo">Salvar</button>
