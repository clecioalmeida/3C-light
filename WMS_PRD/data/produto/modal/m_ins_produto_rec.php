...
$sql_cliente = "select cod_cliente, nm_cliente from tb_cliente where fl_status = 1 and fl_tipo = 'C'" or die(mysqli_error($sql));
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="portlet-body">
            ...
            <fieldset>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="" id="" placeholder="Produto" value="<?php echo $row_select_cliente['nm_cliente']; ?>" readonly="true">
                        <input type="hidden" name="cod_cli" id="cod_cli" value="<?php echo $row_select_cliente['cod_cliente']; ?>">
                        <?php } ?>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <label class="radio-inline"><input type="radio" name="tp_separacao" value="fifo" id="p_separacao">Fifo</label>
                        <label class="radio-inline"><input type="radio" name="tp_separacao" value="fefo" id="p_separacao">Fefo</label>
                        <label class="radio-inline"><input type="radio" name="tp_separacao" value="comum" id="p_separacao">Comum</label>
                        <div class="form-control-focus"> </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <label class="radio-inline"><input type="radio" value="S" name="fl_lote" id="p_lote">Sim</label>
                        <label class="radio-inline"><input type="radio" value="N" name="fl_lote" id="p_lote">Não</label>
                        <div class="form-control-focus"> </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                         <label class="radio-inline"><input type="radio" value="A" name="curva" id="p_curva">A</label>
                         <label class="radio-inline"><input type="radio" value="B" name="curva" id="p_curva">B</label>
                         <label class="radio-inline"><input type="radio" value="C" name="curva" id="p_curva">C</label>
                    <div class="form-control-focus"> </div>
                </div>
      ...
      <div class="modal-footer" style="background-color: #2F4F4F;">
          <button type="submit" class="btn btn-primary" id="btnFormNovoProdutoRec">Salvar</button>
