            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #FFA07A">
                        <h4 class="modal-title" id="myModalLabel">Atualizar saldo de estoque!</h4>
                    </div>
                    <div class="modal-body">                                
                        <?php echo "<h3>As quantidades apuradas e o saldo de estoque não batem! Deseja atualizar o saldo de estoque?</h3>"; ?>
