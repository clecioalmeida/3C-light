...
where p.fl_status = 'A' and p.fl_empresa = '$cod_cli' and p.nr_qtde > 0 and coalesce(p.ds_galpao,0) > 0 and coalesce(p.cod_estoque,0) > 0 and p.cod_prod_cliente = '$id_prd'
