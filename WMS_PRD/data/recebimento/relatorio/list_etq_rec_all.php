...
$query_qtde="SELECT DISTINCT t1.id, t1.nr_docto, t1.cod_item, t1.nr_seq, t3.nr_fisc_ent, t2.produto, substring(t4.nm_produto, 1, 30) as nm_produto, t4.cod_prod_cliente
from tb_etiqueta t1
