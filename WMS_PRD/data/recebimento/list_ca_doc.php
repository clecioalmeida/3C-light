...
left join tb_posicao_pallet t2 on t1.nr_pedido = t2.nr_pedido_ant
...
if ($nr_doc == "") {
	...
	$sql .= $clause . " t1.fl_status = 'F' and t3.nr_matricula is not null and t4.nr_docto is not null";

}else{

	$sql .= $clause . "t4.nr_docto = '".$nr_doc."' and t1.fl_status = 'F' and t3.nr_matricula is not null";

}

$sql .= " order by t4.dt_docto, t5.dt_docto, t3.ds_nome asc
LIMIT 100";
