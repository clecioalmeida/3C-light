          ...
          <fieldset>
            <section>
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="nr_trans_dep" value="<?php echo $nr_trans_dep;?>" required="true" style="text-align: right;">
            ...
            <section>
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="nr_dem_proc" value="<?php echo $nr_dem_proc;?>" required="true" style="text-align: right;">
                  <div class="form-control-focus"> </div>
                </div>
              </section>
            </div>
