<?php 
  ...
  $id_nf = mysqli_real_escape_string($link, $_POST["dtl_nfrec"]);
...
$link->close();
?>
<div class="modal fade" id="detalhe_nf" aria-hidden="true">
    <form method="post" action="xhr/proc_update_nf.php">
                ...
                <div class="modal-body modal-lg" style="overflow-y: auto">
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" value="<?php echo $nr_fisc_ent;?>" id="nr_fisc_ent" name="nr_fisc_ent">
                                <div class="form-control-focus"> </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" value="<?php echo $nr_cfop_ent;?>" id="nr_cfop_ent" name="nr_cfop_ent">
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" value="<?php echo $qtd_vol_ent;?>" id="qtd_vol_ent" name="qtd_vol_ent">
                                <div class="form-control-focus"> </div>
                            </div>
                            <label class="col-sm-2 control-label" for="nr_peso_ent">Peso total</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" value="<?php echo $nr_peso_ent;?>" id="nr_peso_ent" name="nr_peso_ent">
                                <div class="form-control-focus"> </div>
                            </div>
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" value="<?php echo $vl_tot_nf_ent;?>" id="vl_tot_nf_ent" name="vl_tot_nf_ent">
                                <div class="form-control-focus"> </div>
                            </div>
                            <label class="col-sm-2 control-label" for="form_control_cliente">Base ICMS</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" value="<?php echo $base_icms_ent;?>" name="base_icms_ent" id="base_icms_ent">
                                <div class="form-control-focus"> </div>
                            </div>
                            <label class="col-sm-2 control-label" for="base_icms_ent">Valor do ICMS</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" value="<?php echo $vl_icms_ent;?>" id="vl_icms_ent" name="vl_icms_ent">
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo $chavenfe;?>" id="chavenfe" name="chavenfe">
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" value="<?php echo $ds_obs_nf;?>" id="ds_obs_nf" name="ds_obs_nf" id="ds_obs_nf" placeholder="Observação"></textarea>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                    </fieldset>
