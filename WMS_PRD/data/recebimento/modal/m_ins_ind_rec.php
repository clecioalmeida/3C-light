      ...
      <div class="modal-content">
        ...
        <div class="modal-body modal-lg" style="overflow-y: auto">
          ...
          <fieldset>
            <section>
              <div class="form-group">
                <label class="col-sm-3 control-label" for="nm_produto">TOTAL NFS RECEBIDAS</label>
                <div class="col-sm-2">
            ...
            <section>
              <div class="form-group">
                <label class="col-sm-3 control-label" for="nm_produto">TOTAL NFS RECEBIDAS >= 2 DIAS</label>
                <div class="col-sm-2">
