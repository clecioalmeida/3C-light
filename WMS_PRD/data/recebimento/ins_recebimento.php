...
$sql = "insert into tb_recebimento (cod_cli, nm_fornecedor, nr_peso_previsto, nr_volume_previsto, ds_tipo_vol, nm_transportadora, nm_motorista, nm_placa, dt_recebimento_real, tp_recebimento, tp_prd, fl_status, fl_empresa, usr_create, dt_create, nr_insumo, ds_obs) values ($cod_cli, '$nm_fornecedor', '$nr_peso_previsto', '$nr_volume_previsto', '$ds_tipo_vol', '$nm_transportadora', '$nm_motorista', '$nm_placa', '$dt_recebimento_real', '$tp_recebimento', '$tp_prd', 'A', '$cod_cli', '$id', '$date', '$nr_insumo', '$obs')";
