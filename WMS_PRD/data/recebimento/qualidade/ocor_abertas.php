<?php 
include_once('xhr/pesquisa_pendentes.php');
?>
    <div id="content">
						...
						<div>
							...
							<div class="widget-body no-padding">
								<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tbody>
                                        <?php require_once('xhr/pesquisa_pendentes.php');  
                                        while($dados = mysqli_fetch_array($res_ocorrencia)) {
                                        ...
                                        <tr>
                                            <td>
                                                <button type="submit" class="btn btn-primary btn-xs" id="btnUpdOcor" value="<?php echo $dados['cod_ocorrencia']; ?>" style="width: 70px">Alterar</button>
                                                <button type="submit" class="btn btn-primary btn-xs" id="btnFinOcor" value="<?php echo $dados['cod_ocorrencia']; ?>" style="width: 70px">Finalizar</button>
                                            </td>
                                ...
                                <div id="infoOcorrencia" class="row"></div>
