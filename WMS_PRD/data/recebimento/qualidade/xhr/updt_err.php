                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                                
                            <p><h4>Não foi possível realizar as alterações solicitadas.</h4></p>
                        </div>
                        <div class="modal-footer">
                            <a href="http://localhost/wms_dsv/wms/html/includes/forms/qualidade/xhr/m_alterar_ocorrencia.php"><button type="button" class="btn btn-danger">Fechar</button></a>
                        </div>
                    </div>
                </div>
            </div>          
