...
if(isset($cod_produto)){
	$query_prd = "select distinct cod_produto, cod_prod_cliente, nm_produto from tb_produto where cod_prod_cliente = '$cod_cliente' and fl_status <> 'E' and fl_empresa = '$cod_cli'";
