...
$select_nf = "select t1.cod_nf_entrada, t1.nr_fisc_ent, t2.cod_nf_entrada_item, t2.nm_produto, t2.nr_ean, t2.nr_qtde, t2.nr_peso_unit, t2.ds_unid, format(t2.vl_unit,2,'de_DE') as vl_unit
from tb_nf_entrada t1
left join tb_nf_entrada_item t2 on t1.cod_nf_entrada = t2.cod_nf_entrada
where t2.nm_produto like '%$nm_prod%' and t1.cod_rec = '$id_rec' and t1.fl_status <> 'E'";
