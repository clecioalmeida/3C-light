...
$select_nf = "select t1.*, date(t1.dt_emis_Ent) as data_emiss, format(t1.vl_tot_nf_ent,2,'de_DE') as vl_tot_nf, format(t1.vl_icms_ent,2,'de_DE') as vl_icms, t2.nm_cliente, t3.nm_fornecedor
...
?>
<br><br>
<legend>NOTA FISCAL No. <?php echo $nr_fisc_ent;?><button type="submit" class="btn btn-success" id="btnFormUpdNfRecebimento" value="<?php echo $id_nf;?>" style="float: right;margin-top: -10px;width: 100px">Salvar</button></legend>
  ...
  <fieldset>
    <section>
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <textarea class="form-control" value="<?php echo $ds_obs_nf;?>" id="ds_obs_nf" name="ds_obs_nf" placeholder="Observação"></textarea>
          <div class="form-control-focus"> </div>
        </div>
      </div>
    </section>
