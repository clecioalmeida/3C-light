...
// where n.nm_fornecedor = '$nmForn' and n.fl_status <> 'E'";
// $res = mysqli_query($link, $SQL);

$SQL = "SELECT c.id as id_col, c.ds_data, c.nm_fornecedor, c.fl_status, c.usr_create, c.dt_create, p.cod_produto, 
n.id, n.id_produto, n.n_serie, n.status_sap, p.nm_produto, u.nm_user
...
where (c.fl_status = 'A' or c.fl_status = 'P') and date(c.ds_data) >= '$dt_inicio' and date(c.ds_data) <= '$dt_fim'";
$res = mysqli_query($link, $SQL);
