...
from tb_ca t1
inner join tb_posicao_pallet t2 on t1.id = (CASE t1.fl_tipo WHEN 'C' then t2.cod_ca when 'L' THEN t2.cod_laudo END) and coalesce(t2.fl_bloq,'N') = 'N'
...
where t2.ds_galpao <> '7' and COALESCE(t1.nr_docto) > 0 and date(t2.dt_create) >= '2020-11-01'
