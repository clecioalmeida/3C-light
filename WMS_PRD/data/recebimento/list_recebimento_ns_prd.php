...
where n.id_produto = '$codPrd' and n.fl_status <> 'E'";
...
<button type="submit" class="btn btn-success" id="RepNseriePrdGenExcel" style="float:right;width: 100px">Excel</button>
<br><br>
...
<script type="text/javascript">
    $('#RepNseriePrdGenExcel').on('click', function() {
        event.preventDefault();
        $('#RepNseriePrdGenExcel').prop("disabled", true);
        var today = new Date();
        $("#reportSalNserie").table2excel({
            name: "Relatório de números de série",
            filename: "Relatório de números de série"
        });
        $('#RepNseriePrdGenExcel').prop("disabled", false);
