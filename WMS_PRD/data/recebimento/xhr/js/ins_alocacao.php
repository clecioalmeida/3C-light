...
<?php
	...
	$sql_alocacao = " insert into tb_posicao_pallet(d) values () ";

	$resultado_id = mysqli_query($link, $sql_alocacao) or die( mysqli_error( $link ) );
	...
	<div class="modal fade" id="conf_cadastro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<a href="http://www.gisis.com.br/app/WMS/wms/html/produtos.php"><button type="button" class="btn btn-success">Ok</button></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="conf_cadastro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="http://www.gisis.com.br/app/WMS/wms/html/produtos.php"><button type="button" class="btn btn-danger">Ok</button></a>
				</div>
			</div>
		</div>
	</div>          
