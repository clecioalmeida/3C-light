...
$select_produto = "select t2.nr_pedido, t2.cod_ped, t7.cod_estoque, t2.produto, t7.produto, round(t2.nr_qtde,0) as qtde, t2.nr_volume, t3.nm_produto, t3.cod_produto, t3.cod_prod_cliente, t4.fl_status, t4.doc_material, t5.ds_prateleira, t5.ds_coluna, t5.ds_altura, t6.nr_matricula, upper(t6.ds_nome) as ds_nome, t6.cod_depto, t7.cod_ca
...
left join tb_funcionario t6 on t4.cod_almox = t6.nr_matricula
left join tb_posicao_pallet t7 on t5.cod_estoque = t7.cod_estoque
where t4.cod_almox = '$nr_mat' and t4.fl_status = 'F' and t4.fl_empresa = '$cod_cli'";
			...
			<tbody id="retPrdPedido">
				...
				while($dados_produto=mysqli_fetch_assoc($res_produto)){?>
					<tr class="odd gradeX">
						...
						<td class="atualiza" style="text-align: right;"> <?php echo $dados_produto['nr_matricula']; ?> </td>
						<td class="atualiza" style="text-align: right;"> <?php echo $dados_produto['cod_depto']; ?> </td>
						<td class="atualiza"> <?php echo $dados_produto['ds_nome']; ?> </td>
						<td class="atualiza" style="text-align: right;"> <?php echo $dados_produto['cod_prod_cliente']; ?> </td>
