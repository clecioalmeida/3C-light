...
$sql_ped = "SELECT t1.nr_pedido, t1.nr_ped_sap, t2.nr_matricula, t1.ds_destino, upper(t2.ds_nome) as ds_nome, date_format(t1.dt_pedido,'%d/%m/%Y') as dt_pedido, t1.fl_status
from tb_pedido_coleta t1  
left join tb_funcionario t2 on t1.cod_almox = t2.nr_matricula
where t1.fl_status = '$ds_status' and t1.fl_empresa = '$cod_cli'
