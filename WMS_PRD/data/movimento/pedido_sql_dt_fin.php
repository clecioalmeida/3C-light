...
$sql_ped = "select distinct t1.nr_pedido, t1.nr_ped_sap, t1.cod_almox, upper(t3.ds_nome) as ds_nome, t1.ds_destino, date_format(t1.dt_pedido,'%d/%m/%Y') as dt_pedido,  date_format(t1.dt_limite,'%d/%m/%Y') as dt_limite, t1.hr_limite, t1.fl_status 
...
where date(t2.dt_fim_coleta) >= '$dt_ini' and date(t2.dt_fim_coleta) <= '$dt_fim' and t1.fl_empresa = '$cod_cli'";
