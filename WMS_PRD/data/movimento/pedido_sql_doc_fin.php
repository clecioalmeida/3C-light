...
$sql_ped = "select distinct t1.nr_pedido, t1.nr_ped_sap, t1.cod_almox, t3.ds_almox, date_format(t1.dt_pedido,'%d/%m/%Y') as dt_pedido,  date_format(t1.dt_limite,'%d/%m/%Y') as dt_limite, t1.hr_limite, t1.fl_status, date_format(t2.dt_exp,'%d/%m/%Y') as dt_exp, t1.nr_minuta, t1.doc_material 
from tb_pedido_coleta t1 
left join tb_pedido_coleta_produto t2 on t1.nr_pedido = t2.nr_pedido
left join tb_almox t3 on t1.cod_almox = t3.cod_almox where t1.doc_material = '$doc_material'";
