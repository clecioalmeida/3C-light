...
$sql_ped = "select t1.nr_pedido, t1.nr_ped_sap, t1.cod_almox, t3.ds_almox, date_format(t1.dt_pedido,'%d/%m/%Y') as dt_pedido,  date_format(t1.dt_limite,'%d/%m/%Y') as dt_limite, t1.hr_limite, t1.fl_status, date_format(t2.dt_exp,'%d/%m/%Y') as dt_exp, t1.nr_minuta, t1.doc_material, date_format(t4.dt_expedido,'%d/%m/%Y') as dt_expedido 
...
where t1.fl_status = 'F' and t1.fl_empresa = '$cod_cli' group by t1.nr_pedido ORDER BY t1.nr_pedido desc limit 50";
					...
					<tr class="status" data-status="<?php echo $linha['fl_status']; ?>">
						<td style="text-align: center">
							...
							<!--button type="submit" id="btnPrintCol" class="btn btn-info btn-xs" value="<?php echo $linha['nr_pedido']; ?>">Imprimir</button>
								...
								<td style="text-align: right;"> <?php echo $linha['dt_expedido'];?></td>
