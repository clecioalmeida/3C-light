...
$pdf->SetHeaderData(false, false, $sap." - ".$ds_apelido.$ds_prateleira.$ds_coluna.$ds_altura, false);
...
// CODE 128 AUTO
$txt = $sap." - ".$ds_apelido.$ds_prateleira.$ds_coluna.$ds_altura;
$pdf->Write(0, $txt, '', 0, 'C', true, 0, false, false, 0);
//$pdf->Cell(0, 0, "Cod.SAP:".$sap." - ".$ds_apelido.$ds_prateleira.$ds_coluna.$ds_altura, 0, 1);
$pdf->write1DBarcode($produto, 'C128', '', '', '', 26, 1, $style, 'N');
