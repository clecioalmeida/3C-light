...
if (mysqli_num_rows($res_ped) > 0) {
	...
	if ($nr_qtde <= $nr_qtde_old) {
		...
		$sql = "insert into tb_posicao_pallet (produto, cod_produto, ds_galpao, nr_volume, nr_qtde, nr_or, fl_status, fl_tipo, fl_bloq, fl_empresa, user_update, dt_update) values ('$produto', '$cod_produto', '$ds_galpao', '$nr_volume', '$nr_qtde', '$nr_or', 'A', 'T', 'N', '$cod_cli', '$id', '$date')";
