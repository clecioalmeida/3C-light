...
$select_estoque = "SELECT t1.*, t2.cod_produto, t2.nm_produto, t2.cod_prod_cliente, t3.ds_apelido
...
where cod_estoque = '$cod_estoque' and t3.id > 1";
...
$sql_galpao = "SELECT distinct id, nome FROM tb_armazem where id > 1";
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color: #2F4F4F;">
          <h5 class="modal-title" style="color: white">Alocação de produtos</h5>
            ...
            <fieldset>
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  ...
                  <input type="hidden" name="ds_enr" value="<?php echo $ds_enr; ?>" id="ds_enr">
                  <div class="form-control-focus"> </div>
                </div>
              </div>
            </fieldset>
