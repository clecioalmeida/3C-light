...
$select_produto = "select t1.produto, t1.nr_nf_entrada, t2.nm_produto, t2.cod_produto 
from tb_posicao_pallet t1 
left join tb_produto t2 on t1.produto = t2.cod_produto or t1.cod_produto = t2.cod_prod_cliente
where t1.cod_estoque = '$cod_estoque' and t2.fl_status <> 'E'";
...
while($dados_produto=mysqli_fetch_assoc($res_produto)){
    ...
    $produto=$dados_produto["cod_produto"];
    $cod_rec=$dados_produto["nr_nf_entrada"];
}
$select_qtde = "select sum(nr_qtde) as total from tb_posicao_pallet where produto = '$produto' and nr_nf_entrada = '$cod_rec' and ds_galpao = 1";
...
from tb_posicao_pallet t1 
left join tb_produto t2 on t1.produto = t2.cod_produto or t1.cod_produto = t2.cod_prod_cliente
where t1.produto = '$produto' and t1.nr_nf_entrada = '$cod_rec' and t1.ds_galpao > 1 and t2.fl_status <> 'E'";
      ...
      <div class="modal-body modal-lg" style="overflow-y: auto">
          ...
          <fieldset>
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" class="form-control" value="<?php echo number_format($totalqtde,0,",","."); ?>" align="center" id="nr_qtde_old" name="nr_qtde_old" readonly="true">
                <div class="form-control-focus"> </div>
              </div>
            </div>
          </fieldset><br/>
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <select class="form-control" id="id_aval" name="id_aval">
              ...
              <tbody>
                <?php 
                 while($dados_aloc = mysqli_fetch_array($res_aloc)) {
                   $cod_prod_cliente = $dados_aloc['cod_prod_cliente'];
                ?>                        
                <tr class="odd gradeX">
