...
$id_pedido = mysqli_real_escape_string($link,$_POST['quebra_col']);
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #2F4F4F;">
        <h5 class="modal-title" style="color: white">Registrar quebra de estoque</h5>
              ...
              <tbody>
                ...
                <tr class="odd gradeX">
                  ...
                  <td style="text-align:center;"> 
                    <button type="submit" id="btnInsQuebraPrdPed" class="btn btn-primary btn-xs" value="<?php echo $dados_local['cod_col']; ?>">Quebra
                    </button> 
