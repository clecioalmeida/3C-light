...
$link->close();
?>
<div class="modal fade" id="del_projeto" aria-hidden="true">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body modal-lg" style="overflow-y: auto">
        <fieldset>
          <h2>Tem certeza que deseja excluir o projeto da posição <?php echo $ds_apelido.$ds_prateleira.$ds_coluna.$ds_altura.' - '.$ds_projeto; ?>?</h2>
        </fieldset>
        <button type="submit" class="btn btn-danger" id="btnSaveDelProject" value="<?php echo $cod_estoque;?>">Sim</button>
