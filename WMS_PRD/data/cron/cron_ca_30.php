...
if(mysqli_num_rows($res) > 0){
	...
	if ($enviado) {
		...
		$sql_alert = "insert into tb_log_ca (dt_alerta, tp_alerta, fl_status, usr_create, dt_create) values ('$date', 'CA 30 dias', 'OK', '99', '$date')";
		...
		$sql_alert = "insert into tb_log_ca (dt_alerta, tp_alerta, fl_status, usr_create, dt_create) values ('$date', 'CA 30 dias', 'ERRO', '99', '$date')";
		$res_alert = mysqli_query($link, $sql_alert);
	}
	...
	echo "Não há vencimentos.";
		...
		$sql_alert = "insert into tb_log_ca (dt_alerta, tp_alerta, fl_status, usr_create, dt_create) values ('$date', 'CA 30 dias', 'VAZIO', '99', '$date')";
		$res_alert = mysqli_query($link, $sql_alert);
