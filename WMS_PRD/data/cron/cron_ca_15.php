...
if(mysqli_num_rows($res) > 0){
	...
	//$mail->AddAddress('eduardomenocio@growupsti.com.br', 'Sistemas 3C logística');
	...
	$sql_alert = "insert into tb_log_ca (dt_alerta, tp_alerta, fl_status, usr_create, dt_create) values ('$date', 'CA 15 dias', 'VAZIO', '99', '$date')";
...
if ($enviado) {
	...
	$sql_alert = "insert into tb_log_ca (dt_alerta, tp_alerta, fl_status, usr_create, dt_create) values ('$date', 'CA 15 dias', 'OK', '99', '$date')";
	$res_alert = mysqli_query($link, $sql_alert);
	...
	$sql_alert = "insert into tb_log_ca (dt_alerta, tp_alerta, fl_status, usr_create, dt_create) values ('$date', 'CA 15 dias', 'ERRO', '99', '$date')";
	$res_alert = mysqli_query($link, $sql_alert);
}
