...
if(mysqli_num_rows($res) > 0){
	...
	while ($dados = mysqli_fetch_assoc($res)) {
		...
		if($dados['tipo'] == 0){
			...
			$sql_bloq = "update tb_posicao_pallet set fl_bloq = 'S' where cod_estoque = ".$dados['cod_estoque']."";
			$res_bloq = mysqli_query($link, $sql_bloq);
	...
	if ($enviado) {
		...
		$sql_alert = "insert into tb_log_ca (dt_alerta, tp_alerta, fl_status, usr_create, dt_create) values ('$date', 'CA 0 dias', 'OK', '99', '$date')";
		...
		$sql_alert = "insert into tb_log_ca (dt_alerta, tp_alerta, fl_status, usr_create, dt_create) values ('$date', 'CA 0 dias', 'ERRO', '99', '$date')";
		$res_alert = mysqli_query($link, $sql_alert);
		...
		$sql_alert = "insert into tb_log_ca (dt_alerta, tp_alerta, fl_status, usr_create, dt_create) values ('$date', 'CA 0 dias', 'VAZIO', '99', '$date')";
		$res_alert = mysqli_query($link, $sql_alert);
