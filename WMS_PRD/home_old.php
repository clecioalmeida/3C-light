	...
	<body class="desktop-detected pace-done mobile-view-activated smart-style-1 fixed-header fixed-navigation">
					...
					<div class="txt-color-white inline-block">
						...
						<div class="btn-group dropup">
							...
							<ul class="dropdown-menu pull-right text-left">
								<li>
									<div class="padding-5">
										<p class="txt-color-darken font-sm no-margin"></p>
								...
								<li>
									<div class="padding-5">
										<p class="txt-color-darken font-sm no-margin"> <span class="text-danger"></span></p>
										<div class="progress progress-micro no-margin">
		...
		<script type="text/javascript">
                     $(document).ready(function(){
                        $('.totalSKU').width('<?php print $perc_sku; ?>%');
                     
                        if('<?php echo $dados['dias']; ?>' <= '0'){
                           $('.linha').addClass("critico");
                     }else if('<?php echo $dados['dias']; ?>' == '1') {
                         $(".linha").addClass("alerta");
                     }else {
                         $('.linha').addClass("noprazo");
                        }
                 });
