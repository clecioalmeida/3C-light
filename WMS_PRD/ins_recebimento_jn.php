...
<legend>CADASTRAR ORDEM DE RECEBIMENTO
  <button type="button" class="btn btn-primary btn-xs" id="btnInsRecJn" value="<?php echo $cod_recebimento;?>" style="float: right;width: 150px">SALVAR</button>
</legend>
  ...
  <fieldset>
    <section>
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input class="form-control" id="nm_fornecedor" value="<?php echo $nm_fornecedor;?>" placeholder="Fornecedor" type="text">
        </div>
      </div>
    </section>
    <section>
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control" name="nr_insumo" value="<?php echo $pedido;?>" placeholder="Pedido de compra" id="nr_insumo" style="text-align: right;">
        </div>
      </div>
    </section>
  </fieldset>
  <fieldset>
    <section>
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control" name="nr_peso_previsto" value="<?php echo $nr_peso_previsto;?>" placeholder="Peso previsto" id="nr_peso_previsto" style="text-align: right;">
        </div>
      </div>
    </section>
    <section>
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control" name="nr_volume_previsto" value="<?php echo $nr_volume_previsto;?>" placeholder="Volume previsto" id="nr_volume_previsto" style="text-align: right;">
        </div>
      </div>
    </section>
    <section>
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control" name="ds_tipo_vol" value="<?php echo $ds_tipo_vol;?>" placeholder="Tipo de volume" id="ds_tipo_vol" style="text-align: right;">
        </div>
      </div>
    </section>
  </fieldset>
  <fieldset>
    <section>
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control" name="nm_transportadora" value="<?php echo $nm_transportadora;?>" placeholder="Transportador" id="nm_transportadora">
        </div>
      </div>
    </section>
    <section>
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control" name="nm_placa" value="<?php echo $nm_placa;?>" placeholder="Placa" id="nm_placa">
        </div>
      </div>
    </section>
    <section>
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control" name="nm_motorista" value="<?php echo $nm_motorista;?>" placeholder="Motorista" id="nm_motorista">
        </div>
      </div>
    </section>
  </fieldset>
