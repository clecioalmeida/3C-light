...
<button type="submit" id="btnCadNfSaida" class="btn btn-primary" value="<?php echo $nr_pedido; ?>" data-st="<?php echo $fl_status;?>" style="float: right;margin-top: -10px;width: 200px">INSERIR DEM</button>
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">       
          <div class="input-group input-group-md">
            <input class="form-control bs-autocomplete" id="nm_destinatario" value="<?php echo $cod_almox.'-'.$ds_destino;?>" placeholder="Digite dois ou mais caracteres" type="text" data-source="data/recebimento/consulta_entidade.php" data-hidden_field_id="cod_destinatario" data-item_id="cod_cliente" data-item_label="nm_cliente" name="ds_destino" autocomplete="off">
            <input class="form-control" id="cod_destinatario" name="cod_destinatario" value="" type="hidden" readonly>
            <span class="input-group-btn">
              <button class="btn btn-info" type="button" id="btnInsDestPed" style="height: 32px"><span class="fa fa-plus" title data-original-title="Cadastrar Destinatário"></span></button>
      ...
      <div>
        <div class="widget-body">
          ...
          <ul id="myTab2" class="nav nav-tabs bordered">
            ...
            <li>
              <a href="#t3" id="liPedConf" data-ped="<?php echo $nr_pedido;?>" data-toggle="tab">CONFERÊNCIA</a>
            </li>
          </ul>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#liPedConf').on('click', function(){
      ...
      $('#retornoConfPed').load('data/movimento/list_conf_pedido.php?search=',{dtl_ped:'<?php echo $nr_pedido;?>'});
    });
