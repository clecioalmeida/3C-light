...
<form method="POST" action="" id="formUpdRec">
  <fieldset>
    <section>
      <div class="form-group">
        <label for="usr_recebe" class="control-label col-sm-1">PRIMEIRO CONFERENTE</label>
        <div class="col-md-2">
          <select class="form-control" name="usr_recebe" id="usr_recebe">
            <option value=""></option>
            <option value=""></option>
          </select>
        </div>
    ...
    <section>
      <div class="form-group">
        <label for="dt_user_recebido_por" class="control-label col-sm-1">DATA</label>
        <div class="col-md-1">
         <input type="date" class="form-control" name="dt_recebido" id="dt_recebido" value="<?php echo $dt_recebido;?>">
 ...
 <section>
  <div class="form-group">
    <label for="usr_autoriza" class="control-label col-sm-1">SEGUNDO CONFERENTE</label>
    <div class="col-md-2">
     <select class="form-control" name="usr_autoriza" id="usr_autoriza">
      <option value=""></option>
    </select>
  </div>
</div>
<div class="form-group">
  <label for="dt_autoriza" class="control-label col-sm-1">DATA</label>
  <div class="col-md-1">
    <input type="date" class="form-control data" name="dt_autoriza" value="<?php echo $dt_autoriza;?>">
  </div>
</div>
</section>
</fieldset>
      ...
      <div>
        <div class="widget-body">
          ...
          <ul id="myTab2" class="nav nav-tabs bordered">
            <li class="active">
              <a href="#t1" id="liRecNfe" data-id="<?php echo $id_rec;?>" data-toggle="tab">NOTAS FISCAIS <span class="badge bg-color-blue txt-color-white"></span></a>
            </li>
            <li>
              <a href="#t2" id="liRecSap" data-toggle="tab">PRODUTOS SAP</a>
            </li>
            <li>
              <a href="#t3" id="liRecNs" data-toggle="tab">NÚMEROS DE SÉRIE</a>
            </li>
            <li>
              ...
              <article>
                <div>
                  <form class="form-horizontal" method="post" action="" id="">
                    ...
                    <button type="button" class="btn btn-info btn-xs" id="btnNovaNfe" value="<?php echo $id_rec;?>" style="margin-right: 3px;width: 150px" disabled>CADASTRAR NFE</button>
                    <button type="button" class="btn btn-success btn-xs" id="btnImpXml" value="<?php echo $id_rec;?>" style="margin-right: 3px;width: 150px" disabled>IMPORTAR XML</button>
                  </form>
                </div>
              </article>
              <article>
              ...
              <article>
                <div>
                  <form class="form-horizontal" method="post" action="" id="">
                    ...
                    <button type="button" class="btn btn-primary btn-xs" id="btnGeraSap" value="<?php echo $id_rec;?>" style="margin-right: 3px;width: 150px" disabled>GERAR RECEBIMENTO</button>
                    <button type="button" class="btn btn-primary btn-xs" id="btnImpNsSap" value="<?php echo $id_rec;?>" style="margin-right: 3px;width: 150px" disabled>IMPORTA IQ09</button>
                  </form>
                </div>
              </article>
              <article>                                            
              ...
              <article>
                <div>
                  <form class="form-horizontal" method="post" action="" id="">
                    ...
                    <button type="button" class="btn btn-success btn-xs" id="btnNovoOrNs" value="<?php echo $id_rec;?>" style="margin-right: 3px;width: 150px">CADASTRAR NÚMERO DE SÉRIE</button>
                  </form>
                </div>
              </article>
              <article>                                            
