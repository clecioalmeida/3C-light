                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                ...
                                <ul id="myTab1" class="nav nav-tabs bordered">
                                    <li class="active">
                                        <a href="#s6" id="liAlocPend" data-toggle="tab">ALOCAÇÕES PENDENTES <span class="badge bg-color-blue txt-color-white"></span></a>
                                    </li>
                                    <li>
                                        <a href="#s1" id="liAlocGer" data-toggle="tab">ALOCAÇÕES GERADAS </a>
                                    </li>
                                    <!--li>
                                        <a href="#s2" id="liAlocMov" data-toggle="tab">ALOCAÇÕES EM ANDAMENTO</a>
                                    </li>
                                    <li>
                                        ...
                                        <article>
                                            <div>
                                                 <form class="form-horizontal" method="post" action="" id="formAlocCod">
                                                    <label class="input">CONSULTA O.R.
                                                        <input type="text" class="input-xs" id="cod_rec" name="cod_rec" style="color: black">
                                                    </label>
                                                    <button type="submit" id="btnFormalocarCod" class="btn btn-primary btn-xs" style="margin-right: 3px;width: 100px">CONSULTAR</button>
                                                    <span> | </span>
                                                    <label class="input">CONSULTA PRODUTO
                                                    ...
                                                    <button type="submit" id="btnGeraAloc" class="btn btn-success btn-xs" style="margin-right: 3px;width: 150px">GERAR ALOCAÇÃO</button>
                                                </form>
                                            </div>
                                        </article>
                                        <article id="loading">
                                            <div id="info_aloca"></div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $( '#liAlocPend').on('click', function(){
            $('#info_aloca').load('data/movimento/alocar_list.php');
        });

        $( '#liAlocGer').on('click', function(){
            $('#infoAlocaGer').load('data/movimento/alocar_list_ger.php');
        });

        /*$( '#liAlocMov').on('click', function(){
            $('#infoAlocaMov').load('data/movimento/alocar_list_movi.php');
        });*/
    });
</script>
<script type="text/javascript"> 
