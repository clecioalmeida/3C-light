									...
									<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
											<header>
												...
												<h2>Relatório de saldo de posições de torres</h2>
											</header>
											<div>
												<div class="jarviswidget-editbox">
												</div>
																...
																<div class="row">
																	<div class="col-sm-8" style="text-align: left;">
																		<div class="form-group form-inline">
																			<select class="form-control" id="id_torre_pos" name="id_torre_pos">
                                											...
                                											<label for="tags"> Digite a posição</label>
																			<input type="text" class="form-control" id="nr_posicao_dig" name="nr_posicao_dig">
																			<select class="form-control" id="nr_posicao" name="nr_posicao" style="display: none">
																	...
																	<div>
																		...
																		<button type="submit" class="btn btn-primary" id="ConsSaldoPosicao" value="" style="float:right;margin-right: 10px;width: 150px">Consultar</button>
																	</div>
																</div>
																<div class="row">
																	<div id="tabela"></div>
