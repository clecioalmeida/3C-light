		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
				<ul id="sparks" class="">
					...
					<li class="sparks-info">
						<h5> Percentual SKU inventariado <span class="txt-color-greenDark"><i class="fa fa-arrow-circle-up"></i>&nbsp;0%</span></h5>
					</li>
				</ul>
			</div>
		</div>
															...
															<fieldset>
																<div class="row">
																	<div class="form-group" style="text-align: left;">
																		...
																		<label class="col-sm-2 control-label" for="inv_rua">Selecione o inventário e o período</label>
																		<div class="col-sm-10">
...
<script type="text/javascript">    
    $(document).on('click', '#RepInvExcel',function(){
        event.preventDefault();
        var today = new Date();
        $("#dadosTar").table2excel({
            name: "Relatório de tarefas de inventário",
            filename: "Relatório de tarefas de inventário - " + today
        });
    });
</script>