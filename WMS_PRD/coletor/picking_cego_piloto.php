...
RIGHT join tb_funcionario t2 on t1.cod_almox = t2.nr_matricula and t1.fl_empresa = t2.fl_empresa
where t1.fl_empresa = '$cod_cli' and (t1.fl_status = 'M' or t1.fl_status = 'C')";
					...
					<div role="content">
						<div class="jarviswidget-editbox">
							...
							<div class="widget-body">
								<fieldset>
									<form method="post" action="sep_item_cego_piloto.php">
										<div class="form-group">
											...
											<select class="form-control" name="nr_pedido" id="cod_recebimento">
									            ...
									            <option value="<?php echo $dados_pedido['nr_pedido']; ?>"><?php echo $dados_pedido['nr_pedido']." - ".$dados_pedido['cod_almox']." - ".$dados_pedido['ds_nome']; ?></option>
									            <?php } ?>
									        </select>
										</div>
