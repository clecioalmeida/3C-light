...
where t1.fl_conferido = 'C' and t2.fl_empresa = '$cod_cli' and t2.fl_status <> 'F' and t2.ds_prd = 'S'";
		...
		<div class="row">
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" role="widget">
					<header>
						<h4 style="text-align: center">EXPEDIÇÃO POR SERIAL</h4>
					...
					<div role="content">
						...
						<div class="widget-body">
							<fieldset>
								<form method="post" action="expede_onda_serial.php">
