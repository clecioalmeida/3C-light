							...
							<fieldset>
								<div class="form-group">
									...
									<form id="form_conf_end" method="" action="">
										<div class="col-md-12">
											<div class="form-group">
												<input type="text" id="consLocal" name="consLocal" class="form-control" required="true">
											</div>
											<div class="form-group">
											</div>
										</div>
								...
								<div class="produto">
									...
									<div class="row" id="confProdPick">
										<form id="form_conf_prod" method="" action="">
											<div class="col-md-12">
												<div class="form-group">
													<input tabindex="1" type="text" id="barcodeConsPrd" name="barcodeConsPrd" class="form-control" required="true">
												</div>
											</div>
										</form>
									</div>
