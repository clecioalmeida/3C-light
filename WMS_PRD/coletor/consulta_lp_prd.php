				...
				<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" role="widget">
					...
					<div role="content">
						<div class="widget-body">
							<fieldset>
								<div class="produto">
									<legend>Selecione o LP</legend>
									<div class="row" id="confProdPick">
										<form id="form_conf_prod" method="" action="">
											<div class="col-md-12">
												<div class="form-group">
													<input tabindex="1" type="text" id="barcodeConsLpPrd" name="barcodeConsLpPrd" class="form-control" required="true">
													<button class="btn btn-primary" type="button" id="btnConsLpPrd">CONSULTAR</button>
												</div>
											</div>
										</form>
									</div>
