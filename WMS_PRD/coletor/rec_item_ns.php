...
<div data-role="page" id="one" class="jqm-demos jqm-home" style="background-color: white">
	<div data-role="header" class="jqm-header" style="height: 50px">
		...
		<a href="recebimento_ns.php" class="jqm-search-link ui-btn ui-btn-icon-notext ui-corner-all ui-icon-arrow-l ui-nodisc-icon ui-alt-icon ui-btn-left"></a>
		...
		<div class="row">
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" role="widget">
					<header>
						<h4>Cadastrar número de série</h4>
					</header>
					<div role="content">
						...
						<div class="widget-body">
							<form id="formPedido">
								...
								<div class="form-actions">
									<a href="conf_rec_ns.php?cod_recebimento=<?php echo $cod_recebimento;?>" class="btn btn-primary btn-lg btn-block" data-transition="pop" style="text-decoration: none">
