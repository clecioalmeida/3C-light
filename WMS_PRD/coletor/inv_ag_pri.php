...
<div data-role="page" data-dialog="true" style="background-color: white">
	<div data-role="header" data-theme="b">
		<h2>INVENTÁRIO - PRIMEIRA CONTAGEM</h2>
	</div>
			...
			<form id="form_conf_inv" method="" action="">
				<div class="col-md-12">
					<div class="form-group">
						<input type="text" id="localInvAg1" name="localInvAg1" class="form-control" required="true" autofocus="true"/>
						<input type="hidden" id="nr_tar" name="nr_tar" class="form-control" value="<?php echo $id_tarefa;?>">
					</div>
					<div class="form-group">
			...
			<form id="" method="" action="">
				<div class="row" id="confProdInv">
					...
					<form id="form_conf_prod" method="" action="">
						<div class="col-md-12">
							<div class="form-group">
								<input type="text" id="barcodeInvAg1" name="barcodeInvAg1" class="form-control"/>
							</div>
						</div>
					</form>
				</div>
			...
			<div class="row" id="insQtdeInv">
				<form id="formConfInv" method="" action="">
					<div class="col-md-12">
						...
						<div class="form-group">
							<button type="button" id="btnSaveConfProdInvAg1" class="btn btn-success btn-sm">
								<span class="glyphicon glyphicon-floppy-disk"></span> Salvar
							</button>
						</div>
						<div class="form-group">
							<h4 id="retInvQtdeAg"></h4>
						</div>
					</div>
				</form>
			</div>
