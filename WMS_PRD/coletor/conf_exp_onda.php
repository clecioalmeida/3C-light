...
<div data-role="page" data-dialog="true" style="background-color: white">
	...
	<div role="main" class="ui-content" style="background-color: white">
		...
		<div class="row">
			<form id="form_conf_exp_on" method="POST" action="">
				<div class="col-md-12">
					<div class="form-group">
						...
						<label>PRODUTO</label>
						<input tabindex="1" type="text" id="barcode_exp" name="barcode_exp" class="form-control" required="" style="text-align: right;" 
		...
		<button type="text" id="btnSaveConfExpOnda" class="btn btn-success btn-sm" style="background-color: #556B2F;text-shadow: none;color:white;border-color: #fdfbfb">
			<span class="glyphicon glyphicon-floppy-disk"></span> Salvar
		</button>
		<a href="expede_onda.php?dados_ped=<?php echo $dados_ped;?>" class="ui-btn ui-shadow ui-corner-all ui-btn-a" style="background-color: #A52A2A;text-shadow: none;color:white;border-color: #fdfbfb">Fechar</a>
