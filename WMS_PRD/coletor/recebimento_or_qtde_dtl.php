...
$dt_recebimento = $_GET['dt_recebimento'];
								...
								<fieldset>
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="col-md-6">
												<div class="form-group">
													<input type="date" id="dt_recebimento" name="dt_recebimento" class="form-control" value="<?php echo $dt_recebimento; ?>" required="true">
												</div>
											</div>
										</div>
									</div>
											...
											<form id="form_conf_PP" method="" action="">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" id="nr_qtde" name="nr_qtde" class="form-control nr_qtde" value="0" style="text-align: right;" />
														<div class="ui-grid-b">
														...
														<div class="ui-grid-a">
															...
															<!--div class="ui-block-c"><input type="text" id="ds_oleo" name="ds_oleo" value="" placeholder="Oleo/litro"-->
														</div>
													</div>
