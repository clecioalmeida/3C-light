...
<div data-role="page" data-dialog="true" style="background-color: white">
	...
	<div role="main" class="ui-content" style="background-color: white">
		...
		<button type="text" id="btnSaveConfExpOnda3c" class="btn btn-success btn-sm" style="background-color: #556B2F;text-shadow: none;color:white;border-color: #fdfbfb">
			<span class="glyphicon glyphicon-floppy-disk"></span> Salvar
		</button>
		<a href="expede_onda_3c.php?dados_ped=<?php echo $dados_ped;?>" class="ui-btn ui-shadow ui-corner-all ui-btn-a" style="background-color: #A52A2A;text-shadow: none;color:white;border-color: #fdfbfb">Fechar</a>
