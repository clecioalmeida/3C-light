...
<div data-role="page" id="one" class="jqm-demos jqm-home" style="background-color: white">
	<div data-role="header" class="jqm-header" style="height: 50px">
		...
		<a href="expede_on_3c_piloto.php" class="jqm-search-link ui-btn ui-btn-icon-notext ui-corner-all ui-icon-arrow-l ui-nodisc-icon ui-alt-icon ui-btn-left"></a>
						...
						<div class="widget-body">
							<form id="formPedido">
								...
								<div class="form-actions">
									<a href="conf_exp_onda_3c_piloto.php?nr_pedido=<?php echo $nr_pedido;?>&nr_qtde=<?php echo $nr_qtde;?>&nr_conf=<?php echo $conf_item;?>&dados_ped=<?php echo $dados_ped;?>" class="btn btn-primary btn-lg btn-block" data-transition="pop" style="text-decoration: none">
									...
									<a href="list_prd_pedido_3c_piloto.php?dados_ped=<?php echo $dados_ped;?>" class="btn btn-primary btn-lg btn-block" data-transition="pop" style="text-decoration: none">
									...
									<button class="btn btn-success btn-sm" id="btnFinConfExpCegoOn3cPl" value="<?php echo $nr_pedido; ?>" style="background-color: #A52A2A;text-shadow: none;color:white;border-color: #fdfbfb">FINALIZAR</button>
								</div>
							</form>
						</div>
					</div>
