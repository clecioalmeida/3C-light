...
<div data-role="page" id="one" class="jqm-demos jqm-home" style="background-color: white">
	<div data-role="header" class="jqm-header" style="height: 50px">
		...
		<a href="expede_on_serial.php" class="jqm-search-link ui-btn ui-btn-icon-notext ui-corner-all ui-icon-arrow-l ui-nodisc-icon ui-alt-icon ui-btn-left"></a>
							...
							<form id="formPedido">
								<fieldset>
									<div class="form-group">
										...
										<div id="retFinConfExpSerial"></div>
									</div>
								</fieldset>
								<div class="form-actions">
									<a href="conf_exp_serial.php?nr_pedido=<?php echo $nr_pedido;?>&dados_ped=<?php echo $dados_ped;?>" class="btn btn-primary btn-lg btn-block" data-transition="pop" style="text-decoration: none">
									...
									<a href="conf_exp_range_serial.php?nr_pedido=<?php echo $nr_pedido;?>&dados_ped=<?php echo $dados_ped;?>" class="btn btn-primary btn-lg btn-block" data-transition="pop" style="text-decoration: none">
										<button type="button" class="btn btn-primary btn-sm" style="background-color: #2c3e50;text-shadow: none;color:white;border-color: #fdfbfb">RANGE</button>
									</a>
									<a href="list_prd_serial_exp.php?dados_ped=<?php echo $dados_ped;?>" class="btn btn-primary btn-lg btn-block" data-transition="pop" style="text-decoration: none">
									...
									<button class="btn btn-success btn-sm" id="btnFinConfExpSerial" value="<?php echo $nr_pedido; ?>" style="background-color: #A52A2A;text-shadow: none;color:white;border-color: #fdfbfb">FINALIZAR</button>
								</div>
							</form>
						</div>
					</div>
