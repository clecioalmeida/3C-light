	...
	<div role="main" class="ui-content" style="background-color: white;padding-top: 1em">		
		<div class="row">
			...
			<form id="form_conf_prod" method="" action="">
				<div class="col-md-12">
					<div class="form-group">
						<input type="text" id="nr_serial" name="nr_serial" class="form-control" placeholder="Número de série" style="text-align: right;">
						<input type="hidden" id="nrPedConf" name="nrPedConf" class="form-control" value="<?php echo $nr_pedido;?>">
					</div>
				</div>
			</form>
			...
			<a href="sep_item_cego_serial.php?cod_ped=<?php echo $nr_pedido;?>" class="ui-btn ui-shadow ui-corner-all ui-btn-a">Fechar</a>
