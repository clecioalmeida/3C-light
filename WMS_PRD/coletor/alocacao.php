				...
				<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" role="widget">
					...
					<div role="content">
						...
						<div class="widget-body">
							<fieldset>
								<form method="post" action="aloc_item.php">
									<div class="form-group">
										<label>Selecione a alocação</label>
										<select class="form-control" name="cod_rec" id="cod_rec">
											<?php 
											while ($dados_or=mysqli_fetch_assoc($res)) {?>

												<option value="<?php echo $dados_or['cod_recebimento']; ?>">OR: <?php echo $dados_or['cod_recebimento']; ?></option>
											<?php } ?>
										</select>
									</div>
