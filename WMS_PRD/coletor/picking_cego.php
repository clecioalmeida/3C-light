...
$pedido ="select distinct t1.nr_pedido, t1.cod_almox, t2.ds_almox from tb_pedido_coleta t1 RIGHT join tb_almox t2 on t1.cod_almox = t2.cod_almox where t1.fl_empresa = '$cod_cli' and (t1.fl_status = 'M' or t1.fl_status = 'C')";
					...
					<div role="content">
						<div class="jarviswidget-editbox">
							...
							<div class="widget-body">
								<fieldset>
									<form method="post" action="sep_item_cego.php">
