...
from tb_nserie
where cod_pedido = '$nr_pedido' and id_produto = '$cod_produto'";
...
<div data-role="page" data-dialog="true" style="background-color: white">
	<div data-role="header" data-theme="b">
		<h2>EXPEDIÇÃO SERIALIZADOS</h2>
	</div>
	<div role="main" class="ui-content" style="background-color: white;padding-top: 1em">		
		<div class="row">
			<p id="retPrd"></p>
			<div id="retConfSerialExp"></div>
			<form id="form_conf_prod" method="" action="">
				<div class="col-md-12">
					<div class="form-group">
						<input type="text" id="nr_serial_ini_exp" name="nr_serial_ini_exp" class="form-control" placeholder="Número de série inicial" style="text-align: right;">
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<input type="text" id="nr_serial_fim_exp" name="nr_serial_fim_exp" class="form-control" placeholder="Número de série final" style="text-align: right;">
						<input type="hidden" id="nr_ped" name="nr_ped" class="form-control" value="<?php echo $nr_pedido;?>">
					</div>
				</div>
			</form>
			<p><h2 id="retExpPrd"></h2></p>
			<p><h2 id="retExpEnd"></h2></p>
			<button type="submit" class="ui-btn ui-shadow-icon ui-btn-a" id="btnSaveSerial" value="<?php echo $nr_pedido;?>" style="background-color: #2c3e50;text-shadow: none;color:white;border-color: #fdfbfb;float: right">SALVAR</button>
			<!--button type="submit" class="ui-btn ui-shadow-icon ui-btn-a" id="btnFinSerial" value="<?php echo $nr_pedido;?>" style="float: right;margin-left: 5px;background-color: #16a085;text-shadow: none;color:white;border-color: #fdfbfb">FINALIZAR</button-->
			<a href="expede_onda_serial.php?dados_ped=<?php echo $dados_ped;?>" class="ui-btn ui-shadow ui-corner-all ui-btn-a">Fechar</a>
