				...
				<legend>Selecione o produto</legend>
					<div class="row" id="confProdPick">
						...
						<form id="form_conf_prod" method="" action="">
							<div class="col-md-12">
								<div class="form-group">
									<input tabindex="1" type="text" id="barcode" name="barcode" class="form-control" required="true">
								</div>
								<div class="form-group">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    ...
	    $(document).on('click', '#closeModal',function() {
			window.location.href = "sep_item_pedido.php?nr_pedido=<?php echo $nr_pedido;?>";
   		});
	});
