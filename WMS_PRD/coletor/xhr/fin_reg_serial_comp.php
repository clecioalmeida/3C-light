...
$sql_conf = "select id_produto, count(n_serie) as total_prd, ds_prateleira, ds_coluna, ds_altura from tb_nserie where cod_pedido = '$nr_ped' and fl_tipo = 'C' group by id_produto, ds_prateleira, ds_coluna, ds_altura";
...
/*$sql_count = "select id_produto, count(n_serie) as total_prd from tb_nserie where cod_pedido = '$nr_ped' and fl_tipo = 'C' group by id_produto";
