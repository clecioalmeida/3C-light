...
$upd_ped="update tb_pedido_coleta set fl_status = 'X', fl_parc = 'S' where nr_pedido = '$pedido'";
$res_upd_ped=mysqli_query($link, $upd_ped);

$sql = "insert into tb_ocorrencias (nm_ocorrencia, tipo, ds_responsavel, nm_depto, criticidade, dt_abertura, fl_status, cod_origem, ds_obs, fl_empresa, user_create, dt_create) values ('Pedido separado parcialmente', '', '$id', 'Separação', 'A', '$date', 'A', '$pedido', '', '$cod_cli', '$id', '$date')";
$resultado_id = mysqli_query($link1, $sql);
