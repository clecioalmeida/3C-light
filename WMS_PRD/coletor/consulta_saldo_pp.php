		...
		<div class="row">
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" role="widget">
					<header>
						<h4>CONSULTA SALDO POR ENDEREÇO</h4>
					...
					<div role="content">
						<div class="widget-body">
							<fieldset>
								<div class="produto">
									<legend>Bipe o endereço</legend>
									<div class="row" id="confPpPick">
										<form id="form_conf_PP" method="" action="">
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" id="barcodeConsLocPp" name="barcodeConsLocPp" class="form-control" required="true" autofocus="true">
													<button class="btn btn-primary" type="button" id="btnConsPP">CONSULTAR</button>
												</div>
											</div>
										</form>
									</div>
