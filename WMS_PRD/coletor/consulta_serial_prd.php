		...
		<div class="row">
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" role="widget">
					<header>
						<h4>Consulta saldo por serial</h4>
					...
					<div role="content">
						<div class="widget-body">
							<fieldset>
								<div class="produto">
									<legend>Selecione o serial</legend>
									<div class="row" id="confProdPick">
										<form id="form_conf_prod" method="" action="">
											<div class="col-md-12">
												<div class="form-group">
													<input tabindex="1" type="text" id="barcodeConsSerialPrd" name="barcodeConsSerialPrd" class="form-control" required="true">
													<button class="btn btn-primary" type="button" id="btnConsSerialPrd">CONSULTAR</button>
												</div>
											</div>
										</form>
									</div>
