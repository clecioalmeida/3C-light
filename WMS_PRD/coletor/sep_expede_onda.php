...
$sql_ped = "select t1.nr_pedido, t1.produto, sum(t1.nr_qtde) as nr_qtde_col, t1.nr_qtde_conf, t1.nr_qtde_exp, t2.cod_produto, t2.cod_prod_cliente, t2.nm_produto, t3.cod_almox, t3.ds_destino
...
$sql_totalQtde = "select cod_almox, ds_destino
							...
							<form id="formPedido">
								<fieldset>
									<div class="form-group">
										<h5>Pedido número: <?php echo $nr_pedido;?> - Destino: <?php echo $cod_almox."-".$ds_destino;?></h5>
									</div>
								</fieldset>
										...
										<tbody style="font-size: 10px">
											...
											while ($dados_ped = mysqli_fetch_assoc($res_ped)) {?>
												<tr class="tblRows" data_prd="<?php echo $dados_ped['cod_produto']; ?>" data_qtd="<?php echo $dados_ped['nr_qtde_col']; ?>">
													...
													<td id="total" data-conf="<?php echo $dados_ped['nr_qtde_exp']; ?>"><?php echo $dados_ped['nr_qtde_exp']; ?></td>
													<td>
