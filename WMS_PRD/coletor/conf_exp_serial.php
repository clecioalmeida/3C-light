			...
			<form id="form_conf_prod" method="" action="">
				<div class="col-md-12">
					<div class="form-group">
						<input type="text" id="nr_serial_exp" name="nr_serial_exp" class="form-control" placeholder="Número de série" data-ped="<?php echo $nr_pedido;?>" style="text-align: right;" autofocus="true">
						<input type="hidden" id="nr_ped" name="nr_ped" class="form-control" value="<?php echo $nr_pedido;?>">
					</div>
				</div>
			</form>
			<h2 id="retExpEndSerial"></h2>
