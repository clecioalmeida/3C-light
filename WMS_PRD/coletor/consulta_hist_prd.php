										...
										<form id="form_conf_prod" method="" action="">
											<div class="col-md-12">
												<div class="form-group">
													<input tabindex="1" type="text" id="barcodeConsHistPrd" name="barcodeConsHistPrd" class="form-control" required="true">
													<button class="btn btn-primary" type="button" id="btnConsHistPrd">CONSULTAR</button>
												</div>
											</div>
										</form>
									</div>
