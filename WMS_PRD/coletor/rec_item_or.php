...
$query_conf="select count(id) as total from tb_nf_entrada_conf where cod_rec = '$cod_recebimento'";
...
<div data-role="page" id="one" class="jqm-demos jqm-home" style="background-color: white">
	<div data-role="header" class="jqm-header" style="height: 50px">
		...
		<a href="recebimento_or.php" class="jqm-search-link ui-btn ui-btn-icon-notext ui-corner-all ui-icon-arrow-l ui-nodisc-icon ui-alt-icon ui-btn-left"></a>
							...
							<form id="formPedido">
								<fieldset>
									<div class="form-group">
										...
										?></div>
										<h3 id="retFinConfRec"></h3>
									</div>
								</fieldset>
								<div class="form-actions">
									<a href="conf_rec.php?cod_recebimento=<?php echo $cod_recebimento;?>" class="btn btn-primary btn-lg btn-block" data-transition="pop" style="text-decoration: none">
										<button type="button" class="btn btn-primary btn-sm">Iniciar</button>
									</a>
									<button class="btn btn-success btn-sm" id="btnFinConfRec" value="<?php echo $cod_recebimento; ?>">Finalizar</button>
								</div>
							</form>
						</div>
					</div>
