...
if(isset($nr_pedido) || isset($cod_estoque) || isset($cod_col) || isset($id_etq)){
	...
	<div data-role="page" data-dialog="true" style="background-color: white">
		...
		<div role="main" class="ui-content" style="background-color: white;padding-top: 1em">
			...
			<div class="row">
				...
				<div>
					<h4 id="">Endereço:<?php echo $local;?> - Itens a coletar:<?php echo $nr_qtde;?> - Código Vol.:<?php echo $id_etq;?> - Cód. estoque:<?php echo $cod_estoque;?> </h4>
				</div>
				...
				<form id="form_conf_end" method="" action="">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="hidden" id="id_etq" name="id_etq" class="form-control" value="<?php echo $id_etq;?>">
							<input type="hidden" id="nr_qtde" name="nr_qtde" class="form-control" value="<?php echo $nr_qtde;?>">
						</div>
						<div class="form-group">
						</div>
					</div>
			...
			<a href="sep_item_cego_piloto.php?cod_ped=<?php echo $nr_pedido;?>" class="ui-btn ui-shadow ui-corner-all ui-btn-a">Fechar</a>
		</div>
	</div>
	...
	<div data-role="page" data-dialog="true" style="background-color: white">
		...
		<div role="main" class="ui-content" style="background-color: white;padding-top: 1em">
			...
			<a href="home.php;?>" class="ui-btn ui-shadow ui-corner-all ui-btn-a">Fechar</a>
		</div>
	</div>
