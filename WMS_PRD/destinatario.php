										...
										<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											...
											<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
												<header>
													...
													<button type="submit" id="btnNewDestinatario" class="btn btn-default btn-xs" style="float:right; margin-top: 4px; margin-right: 12px">Novo</button>	
												...
												<div>
													...
													<div class="widget-body no-padding" id="dados">
														...
														<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
													        ...
													        <tbody>
													            <?php 
													            require_once('data/entidade/list_destinatario.php');                                                          
