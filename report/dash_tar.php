...
$link->close();
?>
<?php include 'chart_dash.php';?>
<br><br>
<fieldset>
  <header>
    <h1>ATENDIMENTOS POR PROJETO</h1>
  </header>
</fieldset>
<fieldset>
  <section>
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" id="printGraph">
      <header>
        ...
        <h2>TOTAL DE ATENDIMENTOS POR PROJETO</h2>
      </header>
      <div>
        <div class="widget-body no-padding">
          <div id="dash_total_prj" class="chart no-padding"></div>
        </div>
      </div>
    </div> 
  </section>
  <section>
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" id="printGraph">
      <header>
        <span class="widget-icon"></span>
        <h2>TOTAL DE HORAS DE ATENDIMENTO POR SOLICITANTE</h2>
      </header>
      <div>
        <div class="widget-body no-padding">
