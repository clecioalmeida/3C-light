...
$query_pedido = "SELECT t2.nr_pedido, t2.produto, round(t2.nr_qtde_col,0) as nr_qtde, t4.nm_produto, date_format(t2.dt_create,'%d/%m/%Y') as data_ped, UPPER(t7.ds_nome) as ds_nome, t9.nr_docto, date_format(t9.dt_docto,'%d/%m/%Y') as dt_docto, t7.cod_depto
