...
$query_pedido = "SELECT t2.nr_pedido, t2.produto, round(t2.nr_qtde,0) as nr_qtde, format(t2.vl_unit,2,'de_De') as vl_unit, t4.nm_produto, date_format(t2.dt_create,'%d/%m/%Y') as data_ped, UPPER(t7.ds_nome) as ds_nome, t6.ds_custo, t7.cod_depto
