														...
														<div class="row">
															<?php while ($dados_b = mysqli_fetch_assoc($tempo_b)) {?>
																<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> 
																	<span class="text"> Tempo médio até o início da coleta: 
																		<span class="pull-right"><?php echo number_format($dados_b['inicio_coleta'], 2, ',', ' '); ?> Dias
																		</span> 
																	</span>
																	<div class="progress">
																		<div class="progress-bar bg-color-blueDark" style="width: <?php echo number_format($dados_b['inicio_coleta'], 2, ',', ' '); ?>">
																		</div>
																	</div> 
																</div>
															<?php }?>
															<?php while ($dados_c = mysqli_fetch_assoc($tempo_c)) {?>
																<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> 
																	<span class="text"> Tempo médio de coleta: 
																		<span class="pull-right"><?php echo number_format($dados_c['tempo_coleta'], 2, ',', ' '); ?> Dias
																		</span> 
																	</span>
																	<div class="progress">
																		<div class="progress-bar bg-color-blueDark" style="width: <?php echo number_format($dados_c['tempo_coleta'], 2, ',', ' '); ?>">
																		</div>
																	</div> 
																</div>
															<?php }?>
															<?php while ($dados_a = mysqli_fetch_assoc($tempo_a)) {?>
																<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> 
																	<span class="text"> Tempo médio até a expedição: 
																		<span class="pull-right"><?php echo number_format($dados_a['tempo_total'], 2, ',', ' '); ?> Dias
																		</span> 
																	</span>
																	<div class="progress">
																		<div class="progress-bar bg-color-blueDark" style="width: <?php echo number_format($dados_a['tempo_total'], 2, ',', ' '); ?>">
																		</div>
																	</div> 
																</div>
															<?php }?>
													...
													<?php while ($status = mysqli_fetch_assoc($res_status)) {?>
														<div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
															...
															<div class="easy-pie-chart txt-color-orangeDark" data-percent="<?php echo ($status['total_status'] / $status['total']) * 100; ?>" data-pie-size="50">
																<span class="percent percent-sign"><?php echo ($status['total'] / $status['total_status']) * 100; ?>
															</span>
														</div>
														<span class="easy-pie-title"> <?php echo $status['tr_status']; ?> <i class="fa fa-caret-up icon-color-bad"></i> 
														</span>
													</div>
												<?php }?>
											</div>
												...
												<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 show-stats">
													<div class="row">
														<?php while ($dados_rec_a = mysqli_fetch_assoc($rec_a)) {?>
															<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> 
																<span class="text"> Tempo médio entre registro e chegada recebimento: 
																	<span class="pull-right"><?php echo number_format($dados_rec_a['tempo_total'], 2, ',', ' '); ?> Dias
																	</span> 
																</span>
																<div class="progress">
																	<div class="progress-bar bg-color-blueDark" style="width: <?php echo number_format($dados_rec_a['tempo_total'], 2, ',', ' '); ?>">
																	</div>
																</div> 
															</div>
														<?php }?>
														<?php while ($dados_rec_b = mysqli_fetch_assoc($rec_b)) {?>
															<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> 
																<span class="text"> Tempo médio entre registro e efetivação do recebimento: 
																	<span class="pull-right"><?php echo number_format($dados_rec_b['tempo_rec'], 2, ',', ' '); ?> Dias
																	</span> 
																</span>
																<div class="progress">
																	<div class="progress-bar bg-color-blueDark" style="width: <?php echo number_format($dados_rec_b['tempo_rec'], 2, ',', ' '); ?>">
																	</div>
																</div> 
															</div>
														<?php }?>
												...
												<?php while ($status_rec = mysqli_fetch_assoc($res_status_rec)) {?>
													<div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
														...
														<div class="easy-pie-chart txt-color-orangeDark" data-percent="<?php echo ($status_rec['total_status_rec'] / $status_rec['total_rec']) * 100; ?>" data-pie-size="50">
															<span class="percent percent-sign"><?php echo ($status_rec['total_rec'] / $status_rec['total_status_rec']) * 100; ?>
														</span>
													</div>
													<span class="easy-pie-title"> <?php echo $status_rec['tr_status_rec']; ?> <i class="fa fa-caret-up icon-color-bad"></i> 
													</span>
												</div>
											<?php }?>
										</div>
											...
											<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 show-stats">
												<div class="row">
													<?php while ($dados_media_a = mysqli_fetch_assoc($ped_media_a)) {?>
														<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> 
															<span class="text"> Tempo médio entre emissão do pedido e data limite: 
																<span class="pull-right"><?php echo number_format($dados_media_a['tempo_a'], 2, ',', ' '); ?> Dias
																</span> 
															</span>
															<div class="progress">
																<div class="progress-bar bg-color-blueDark" style="width: <?php echo number_format($dados_media_a['tempo_a'], 2, ',', ' '); ?>">
																</div>
															</div> 
														</div>
													<?php }?>
													<?php while ($dados_media_b = mysqli_fetch_assoc($ped_media_b)) {?>
														<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> 
															<span class="text"> Tempo médio entre data limite de expedição  e efetivação da entrega: 
																<span class="pull-right"><?php echo number_format($dados_media_b['tempo_b'], 2, ',', ' '); ?> Dias
																</span> 
															</span>
															<div class="progress">
																<div class="progress-bar bg-color-blueDark" style="width: <?php echo number_format($dados_media_b['tempo_b'], 2, ',', ' '); ?>">
																</div>
															</div> 
														</div>
													<?php }?>
