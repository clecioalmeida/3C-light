$(document).ready(function () {
    ...
    $.getJSON('assets/php/list_ag_fin.php', function (data) {
        ...
        var table = $("#tb_rec_fin").DataTable({
          sDom:
            "<'dt-toolbar d-flex'<f><'ml-auto hidden-xs show-control'l>r>" +
            "t" +
        ...
        $("#tb_rec_fin tbody").on("click", "td.details-control", function () {
