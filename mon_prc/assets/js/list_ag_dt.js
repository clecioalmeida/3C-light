$(document).ready(function () {
    ...
    $('#pesq_dt').on('click', function () {
        event.preventDefault(); if ($('#dt_ini_ag').val() == '' || $('#dt_fim_ag').val() == '') {
            ...
            $.getJSON('assets/php/list_ag_dt.php?search=', { dt_ini_ag: dt_ini_ag, dt_fim_ag: dt_fim_ag, ajax: 'true' }, function (data) {
