...
foreach ($fl_empresa as $key => $value) {
	...
	where date(t1.dt_create) = curdate()-1 and t1.fl_empresa = '$value'";
	...
	from tb_pedido_coleta t1
	where date(t1.dt_create) = curdate()-1 and t1.fl_empresa = '$value' and t1.fl_status = 'F'";
	...
	from tb_pedido_coleta t1
	where date(t1.dt_create) = curdate()-1 and t1.fl_empresa = '$value' and t1.fl_status = 'F' and t1.ds_tipo = 'EMERGENCIAL'";
